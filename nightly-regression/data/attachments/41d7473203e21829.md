...
- Name: validation/auth-validation.spec.ts >> auth validation and error handling >> registration rejects an invalid email and weak password before OTP
- Location: tests/e2e/validation/auth-validation.spec.ts:24:3
...
+   "500 https://api.musticker.com/index.php/sys/kr/user/me?t=1785874072143",
