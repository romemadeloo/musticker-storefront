...
Locator: getByRole('heading', { name: '아트지 롤 스티커', exact: true }).first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: '아트지 롤 스티커', exact: true }).first()
...
- Array []
+ Array [
+   "403 https://www.musticker.com/kr/roll-stickers/paper-roll",
+ ]
```
