...
- Name: purchasing/sticker-catalog-configurator.spec.ts >> storefront v2 catalog: plain die-cut shape stickers >> MS-V2-061 타원형 롤 스티커 supports size and quantity selection through to cart
...
Locator: getByRole('heading', { name: '타원형 롤 스티커', exact: true }).first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: '타원형 롤 스티커', exact: true }).first()
...
- Array []
+ Array [
+   "403 https://www.musticker.com/kr/roll-stickers/oval-roll",
+ ]
```
