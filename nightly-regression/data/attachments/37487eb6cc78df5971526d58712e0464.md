...
- Name: pricing/price-interpolation.spec.ts >> pricing interpolation rectangle-sticker >> MS-PRC-INT-rectangle-sticker area 162 (9x18) interpolates between 100 and 225
- Location: tests/e2e/pricing/price-interpolation.spec.ts:103:7

# Error details

```
Error: rectangle-sticker area 162 (9x18) qty 300 upper bound total should be the UNROUNDED 225 row product: served pricing_id=48 "diecut/kisscut - 9/9/2026"

expect(received).toBeCloseTo(expected, precision)

Expected: 27999.999675
Received: 28000.0125

Expected precision:    4
Expected difference: < 0.00005
Received difference:   0.012825000001612352
```
