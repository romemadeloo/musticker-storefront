...
- Name: pricing/price-interpolation.spec.ts >> pricing interpolation kiss-cut-sticker >> MS-PRC-INT-kiss-cut-sticker area 543000 (724x750) interpolates between 540000 and 546000
- Location: tests/e2e/pricing/price-interpolation.spec.ts:103:7

# Error details

```
Error: kiss-cut-sticker area 543000 (724x750) qty 300 lower bound total should be the UNROUNDED 540000 row product: served pricing_id=48 "diecut/kisscut - 9/9/2026"
...
Received difference:   61.56000000005588
```
