...
- Name: pricing/price-table.spec.ts >> pricing table paper-roll >> MS-PRC-paper-roll area 2025 (45x45) matches roll-stickers/paper-roll.csv
- Location: tests/e2e/pricing/price-table.spec.ts:59:7

# Error details

```
Error: paper-roll area 2025 (45x45): served pricing_id=55 "paper roll - 9/10/2026"
