...
- Name: pricing/price-table.spec.ts >> pricing table rounded-roll >> MS-PRC-rounded-roll area 38025 (195x195) matches roll-stickers/rounded-roll.csv
- Location: tests/e2e/pricing/price-table.spec.ts:59:7

# Error details

```
Error: rounded-roll area 38025 (195x195): served pricing_id=53 "diecut/kisscut roll - 9/10/2026"
