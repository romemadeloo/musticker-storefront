...
- generic [ref=e3]:
  ...
  - main [ref=e30]:
    - generic [ref=e31]:
      ...
      - generic [ref=e147]:
        ...
        - heading "0개 사진 후기가 보장해요" [level=2] [ref=e162]
        ...
        - generic [ref=e164]:
          ...
          - button "다음 리뷰" [disabled] [ref=e169] [cursor=pointer]:
            - img [ref=e170]
      ...
      - generic [ref=e174]:
        - generic [ref=e175]:
          - img "text" [ref=e176]
          - generic [ref=e177]:
            - heading "원형 시트 스티커 FAQ" [level=2] [ref=e178]
            - paragraph [ref=e179]:
              - text: 멤버십, 주문, 디자인 파일 업로드, 인쇄, 결제, 반품·환불에 대한 자세한 내용은 자주 묻는
              - link "질문(FAQ) 페이지에서 확인해 주세요" [ref=e180] [cursor=pointer]:
                - /url: https://www.musticker.com/faq
              - text: .
        - generic [ref=e181]:
          - generic [ref=e182]:
            - generic [ref=e183] [cursor=pointer]:
              - heading "원형 시트 스티커란 무엇인가요?" [level=3] [ref=e184]
              - paragraph [ref=e187]: 원형 시트 스티커는 여러 개의 원형 스티커를 한 장의 시트에 배치해 제작하는 스티커입니다. 각 스티커는 키스컷 방식으로 제작되어 시트는 그대로 유지되며, 스티커를 한 장씩 쉽게 떼어 사용할 수 있습니다.
            - button [ref=e188] [cursor=pointer]:
              - img [ref=e189]
          - generic [ref=e191]:
            - generic [ref=e192] [cursor=pointer]:
              - heading "원형 시트 스티커는 방수 및 내구성이 있나요?" [level=3] [ref=e193]
              - paragraph [ref=e194]: 네. 머스티커의 원형 시트 스티커는 방수 기능이 있는 PVC 소재로 제작됩니다. 둥근 형태로 가장자리가 깔끔하게 마감되어 다양한 용도로 편리하게 사용할 수 있습니다. 다만 날카로운 물체나 강한 마찰에는 긁힘이 생길 수 있으니 주의해 주세요.
            - button [ref=e195] [cursor=pointer]:
              - img [ref=e196]
          - generic [ref=e198]:
            - generic [ref=e199] [cursor=pointer]:
              - heading "한 장의 시트에 여러 가지 원형 디자인을 넣을 수 있나요?" [level=3] [ref=e200]
              - paragraph [ref=e201]: 아니요. 원형 시트 스티커는 하나의 디자인이 시트 전체에 반복 배치되어 제작됩니다. 모든 스티커가 동일한 크기와 간격으로 배치되어 깔끔하게 제작됩니다.
            - button [ref=e202] [cursor=pointer]:
              - img [ref=e203]
          - generic [ref=e205]:
            - generic [ref=e206] [cursor=pointer]:
              - heading "원형 스티커는 정확한 원형으로 제작되나요?" [level=3] [ref=e207]
              - paragraph [ref=e208]: 네. 모든 원형 스티커는 깔끔한 원형으로 제작됩니다. 디자인이 중앙에 맞게 배치되어 좌우 균형이 잘 잡힌 형태로 완성됩니다.
            - button [ref=e209] [cursor=pointer]:
              - img [ref=e210]
          - generic [ref=e212]:
            - generic [ref=e213] [cursor=pointer]:
              - heading "원형 시트 스티커는 어떤 소재를 선택할 수 있나요?" [level=3] [ref=e214]
              - paragraph [ref=e215]: 원형 시트 스티커는 PVC(백색), 투명, 홀로그램 소재로 제작할 수 있습니다. 선명한 색감을 원한다면 PVC(백색), 깔끔하고 자연스러운 느낌을 원한다면 투명, 반짝이는 효과를 원한다면 홀로그램을 추천합니다.
            - button [ref=e216] [cursor=pointer]:
              - img [ref=e217]
        - generic [ref=e219]:
          - generic [ref=e220]:
            - heading "궁금한 점이 더 있으신가요?" [level=4] [ref=e221]
            - paragraph [ref=e222]: 원하시는 답변을 찾지 못하셨다면 언제든지 문의해 주세요.
          - button "문의하기" [ref=e223] [cursor=pointer]:
            - generic [ref=e224]: 문의하기
    - navigation "네이버 톡톡으로 문의하기" [ref=e225]:
      - link "카카오채널로 문의하기" [ref=e226] [cursor=pointer]:
        ...
        - img [ref=e228]
      - link "네이버 톡톡 으로 문의하기" [ref=e229] [cursor=pointer]:
        ...
        - img [ref=e231]
      - generic "이메일로 문의하기" [ref=e232] [cursor=pointer]:
        - generic:
          - generic:
            - generic:
              - img
  ...
  - contentinfo [ref=e235]:
    - generic [ref=e236]:
      - generic [ref=e237]:
        - heading "MUSTICKER / 머스티커" [level=2] [ref=e238]
        - paragraph [ref=e239]: "상호명: (주)글로픽스"
        - paragraph [ref=e240]: "사업자등록번호 : 877-88-03313 통신판매업신고 : 2026-부산해운대-0792호"
        - paragraph [ref=e241]: "대표이사 : 여일석 주소 : 부산광역시 해운대구 해운대해변로 203 오션타워 1014호"
        - paragraph [ref=e242]: "호스팅사업자 : 아마존웹서비시즈(Amazon Web Services)"
        - paragraph [ref=e243]:
          - generic [ref=e244]: ⓒ 2026. All rights reserved.
          - generic [ref=e245]: "판매: sales@musticker.com"
          - link "이용약관" [ref=e246] [cursor=pointer]:
            - /url: /kr/terms-of-use
          - link "개인정보처리방침" [ref=e247] [cursor=pointer]:
            - /url: /kr/privacy-policy
          - generic [ref=e248] [cursor=pointer]: 사업자정보확인
          - link "회사소개" [ref=e249] [cursor=pointer]:
            - /url: /kr/about
      - generic [ref=e250]:
        - paragraph [ref=e251]: 1899-5529
        - paragraph [ref=e253]: 오전 9시 ~ 오후 6시(토요일, 공휴일 휴무)
        - generic [ref=e254]:
          - button "1:1문의하기" [ref=e255] [cursor=pointer]
          - link "자주 묻는 질문" [ref=e256] [cursor=pointer]:
            - /url: /kr/faq
```
