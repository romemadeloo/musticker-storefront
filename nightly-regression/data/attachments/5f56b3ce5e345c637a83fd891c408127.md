...
- Name: pricing/price-interpolation.spec.ts >> pricing interpolation rounded-sticker >> MS-PRC-INT-rounded-sticker highest grid row 546000 (728x750) prices from the CSV
- Location: tests/e2e/pricing/price-interpolation.spec.ts:219:7

# Error details

```
Error: rounded-sticker area 546000 (728x750) qty 10000: served pricing_id=48 "diecut/kisscut - 9/9/2026"
