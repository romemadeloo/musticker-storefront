...
- generic [ref=e3]:
  ...
  - main [ref=e30]:
    - generic [ref=e31]:
      ...
      - generic [ref=e172]:
        ...
        - heading "0개 사진 후기가 보장해요" [level=2] [ref=e187]
        ...
        - generic [ref=e189]:
          ...
          - button "다음 리뷰" [disabled] [ref=e194] [cursor=pointer]:
            - img [ref=e195]
      ...
      - generic [ref=e199]:
        - generic [ref=e200]:
          - img "text" [ref=e201]
          - generic [ref=e202]:
            - heading "둥근 사각 스티커 FAQ" [level=2] [ref=e203]
            - paragraph [ref=e204]:
              - text: 멤버십, 주문, 디자인 파일 업로드, 인쇄, 결제, 반품·환불에 대한 자세한 내용은 자주 묻는
              - link "질문(FAQ) 페이지에서 확인해 주세요" [ref=e205] [cursor=pointer]:
                - /url: https://www.musticker.com/faq
              - text: .
        - generic [ref=e206]:
          - generic [ref=e207]:
            - generic [ref=e208] [cursor=pointer]:
              - heading "둥근사각형 스티커의 특징은 무엇인가요?" [level=3] [ref=e209]
              - paragraph [ref=e212]: 둥근사각형 스티커는 직선의 깔끔함과 부드러운 곡선 모서리가 조화를 이루는 스티커입니다. 로고, 제품 라벨 등 깔끔하면서도 부드러운 느낌을 원하는 디자인에 잘 어울립니다.
            - button [ref=e213] [cursor=pointer]:
              - img [ref=e214]
          - generic [ref=e216]:
            - generic [ref=e217] [cursor=pointer]:
              - heading "둥근사각형 스티커는 방수 및 내구성이 있나요?" [level=3] [ref=e218]
              - paragraph [ref=e219]: 네. 머스티커의 둥근사각형 스티커는 내구성이 뛰어난 PVC 용지에 인쇄되어 물, 변색, 일상적인 마모에 강합니다. 깨끗하고 평평한 표면에 부착하면 실내외 다양한 환경에서 오래 사용할 수 있습니다. 다만 날카로운 물체나 강한 마찰에는 긁힘이 생길 수 있으니 주의해 주세요.
            - button [ref=e220] [cursor=pointer]:
              - img [ref=e221]
          - generic [ref=e223]:
            - generic [ref=e224] [cursor=pointer]:
              - heading "둥근사각형 스티커를 제품 라벨로 사용할 수 있나요?" [level=3] [ref=e225]
              - paragraph [ref=e226]: 네. 둥근사각형 스티커는 제품 라벨, 패키지 포장, 브랜드 굿즈 등 다양한 용도로 많이 사용됩니다. 깔끔하면서도 부드러운 느낌을 연출하기에 적합합니다.
            - button [ref=e227] [cursor=pointer]:
              - img [ref=e228]
          - generic [ref=e230]:
            - generic [ref=e231] [cursor=pointer]:
              - heading "둥근사각형 스티커도 맞춤 사이즈로 제작할 수 있나요?" [level=3] [ref=e232]
              - paragraph [ref=e233]: 네. 다양한 규격 사이즈를 제공하며, 원하는 사이즈로도 제작할 수 있습니다.
            - button [ref=e234] [cursor=pointer]:
              - img [ref=e235]
          - generic [ref=e237]:
            - generic [ref=e238] [cursor=pointer]:
              - heading "둥근 모서리는 인쇄 영역에 영향을 주나요?" [level=3] [ref=e239]
              - paragraph [ref=e240]: 아니요. 둥근 모서리로 제작되어도 인쇄 가능한 영역은 거의 동일하며, 부드럽고 깔끔하게 마감됩니다.
            - button [ref=e241] [cursor=pointer]:
              - img [ref=e242]
        - generic [ref=e244]:
          - generic [ref=e245]:
            - heading "궁금한 점이 더 있으신가요?" [level=4] [ref=e246]
            - paragraph [ref=e247]: 원하시는 답변을 찾지 못하셨다면 언제든지 문의해 주세요.
          - button "문의하기" [ref=e248] [cursor=pointer]:
            - generic [ref=e249]: 문의하기
  ...
  - contentinfo [ref=e260]:
    - generic [ref=e261]:
      - generic [ref=e262]:
        - heading "MUSTICKER / 머스티커" [level=2] [ref=e263]
        - paragraph [ref=e264]: "상호명: (주)글로픽스"
        - paragraph [ref=e265]: "사업자등록번호 : 877-88-03313 통신판매업신고 : 2026-부산해운대-0792호"
        - paragraph [ref=e266]: "대표이사 : 여일석 주소 : 부산광역시 해운대구 해운대해변로 203 오션타워 1014호"
        - paragraph [ref=e267]: "호스팅사업자 : 아마존웹서비시즈(Amazon Web Services)"
        - paragraph [ref=e268]:
          - generic [ref=e269]: ⓒ 2026. All rights reserved.
          - generic [ref=e270]: "판매: sales@musticker.com"
          - link "이용약관" [ref=e271] [cursor=pointer]:
            - /url: /kr/terms-of-use
          - link "개인정보처리방침" [ref=e272] [cursor=pointer]:
            - /url: /kr/privacy-policy
          - generic [ref=e273] [cursor=pointer]: 사업자정보확인
          - link "오픈소스 라이선스" [ref=e274] [cursor=pointer]:
            - /url: /kr/open-source-licenses
          - link "회사소개" [ref=e275] [cursor=pointer]:
            - /url: /kr/about
      - generic [ref=e276]:
        - paragraph [ref=e277]: 1899-5529
        - paragraph [ref=e279]: 오전 9시 ~ 오후 6시(토요일, 공휴일 휴무)
        - generic [ref=e280]:
          - button "1:1문의하기" [ref=e281] [cursor=pointer]
          - link "자주 묻는 질문" [ref=e282] [cursor=pointer]:
            - /url: /kr/faq
        - generic [ref=e283]:
          - generic [ref=e284]: "Follow us at:"
          - generic [ref=e285]:
