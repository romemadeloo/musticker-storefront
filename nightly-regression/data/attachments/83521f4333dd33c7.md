...
- Name: purchasing/product-matrix.spec.ts >> representative product matrix >> configures Vinyl Lettering from lettering
...
+   "[error] [nuxt] error caught during app initialization {error: true, url: /kr/stickers/vinyl-lettering, statusCode: 500, statusMessage: API Response Contract Violation: Expected ApiResponse structure., message: API Response Contract Violation: Expected ApiResponse structure.}",
...
- Array []
+ Array [
+   "500 https://www.musticker.com/kr/stickers/vinyl-lettering",
+   "500 https://api.musticker.com/index.php/sys/kr/navigation/categories",
+   "500 https://api.musticker.com/index.php/sys/kr/user/me?t=1785874012734",
+   "500 https://api.musticker.com/index.php/sys/kr/seo?page=%2Fkr%2Fstickers%2Fvinyl-lettering",
+ ]
```
