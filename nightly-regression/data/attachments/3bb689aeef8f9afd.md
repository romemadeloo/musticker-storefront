...
- Name: purchasing/product-matrix.spec.ts >> representative product matrix >> configures Die Cut Roll from roll stickers
...
+   "[error] [nuxt] error caught during app initialization {error: true, url: /kr/roll-stickers/die-cut-roll, statusCode: 500, statusMessage: API Response Contract Violation: Expected ApiResponse structure., message: API Response Contract Violation: Expected ApiResponse structure.}",
...
+   "500 https://api.musticker.com/index.php/sys/kr/user/me?t=1785873913827",
+   "500 https://api.musticker.com/index.php/sys/kr/seo?page=%2Fkr%2Froll-stickers%2Fdie-cut-roll",
+ ]
```
