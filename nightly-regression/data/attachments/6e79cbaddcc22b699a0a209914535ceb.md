    ...
    - generic [ref=e31]:
      ...
      - generic [ref=e596]:
        - generic [ref=e597]:
          - img "text" [ref=e598]
          - generic [ref=e599]:
            - heading "직사각형 시트 스티커 FAQ" [level=2] [ref=e600]
            - paragraph [ref=e601]:
        ...
        - generic [ref=e603]:
          - generic [ref=e604]:
            - generic [ref=e605] [cursor=pointer]:
              - heading "직사각형 시트 스티커란 무엇인가요?" [level=3] [ref=e606]
              - paragraph [ref=e609]: 직사각형 시트 스티커는 여러 개의 직사각형 스티커를 한 장의 시트에 배치해 제작하는 스티커입니다. 각 스티커는 키스컷 방식으로 제작되어 시트는 그대로 유지되며, 스티커를 한 장씩 쉽게 떼어 사용할 수 있습니다
            - button [ref=e610] [cursor=pointer]:
              - img [ref=e611]
          - generic [ref=e613]:
            - generic [ref=e614] [cursor=pointer]:
              - heading "한 장의 시트에 여러 가지 직사각형 디자인을 넣을 수 있나요?" [level=3] [ref=e615]
              - paragraph [ref=e616]: 아니요. 직사각형 시트 스티커는 하나의 디자인이 시트 전체에 반복 배치되어 제작됩니다. 모든 스티커가 동일한 크기와 간격으로 배치되어 깔끔하게 제작됩니다.
            - button [ref=e617] [cursor=pointer]:
              - img [ref=e618]
          - generic [ref=e620]:
            - generic [ref=e621] [cursor=pointer]:
              - heading "직사각형 시트 스티커는 어떤 소재를 선택할 수 있나요?" [level=3] [ref=e622]
              - paragraph [ref=e623]: 직사각형 시트 스티커는 PVC(백색), 투명, 홀로그램 소재로 제작할 수 있습니다. 선명한 색감을 원한다면 PVC(백색), 깔끔하고 자연스러운 느낌을 원한다면 투명, 반짝이는 효과를 원한다면 홀로그램을 추천합니다.
            - button [ref=e624] [cursor=pointer]:
              - img [ref=e625]
          - generic [ref=e627]:
            - generic [ref=e628] [cursor=pointer]:
              - heading "직사각형 시트 스티커는 방수 및 내구성이 있나요?" [level=3] [ref=e629]
              - paragraph [ref=e630]: 네. 머스티커의 직사각형 시트 스티커는 방수 기능이 있는 PVC 소재로 제작됩니다. 다만 날카로운 물체나 강한 마찰에는 긁힘이 생길 수 있으니 주의해 주세요.
            - button [ref=e631] [cursor=pointer]:
              - img [ref=e632]
          - generic [ref=e634]:
            - generic [ref=e635] [cursor=pointer]:
              - heading "디자인을 직사각형 전체에 인쇄할 수 있나요?" [level=3] [ref=e636]
              - paragraph [ref=e637]: 네. 재단선 밖까지 디자인을 여유 있게 넣어 작업하면 직사각형 전체를 가득 채워 인쇄할 수 있습니다. 이렇게 재단 여백을 포함해 디자인하면 흰 테두리 없이 깔끔하게 제작됩니다
