...
- Name: validation/auth-validation.spec.ts >> auth validation and error handling >> non-member order lookup does not expose a mismatched order
- Location: tests/e2e/validation/auth-validation.spec.ts:40:3
...
+   "500 https://api.musticker.com/index.php/sys/kr/user/me?t=1785874107478",
