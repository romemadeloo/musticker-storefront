...
- Name: pricing/price-table.spec.ts >> pricing table die-cut-roll >> MS-PRC-die-cut-roll area 10000 (100x100) matches roll-stickers/die-cut-roll.csv
- Location: tests/e2e/pricing/price-table.spec.ts:59:7

# Error details

```
Error: die-cut-roll area 10000 (100x100): served pricing_id=53 "diecut/kisscut roll - 9/10/2026"
