    ...
    - generic [ref=e31]:
        ...
        - generic [ref=e36]:
          ...
          - complementary [ref=e61]:
            ...
            - generic [ref=e90]:
              ...
              - generic [ref=e92]:
                - button "5시트 3,420원" [ref=e93] [cursor=pointer]:
                  - generic [ref=e94]: 5시트
                  - generic [ref=e95]: 3,420원
                - button "10시트 6,630원" [ref=e96] [cursor=pointer]:
                  - generic [ref=e97]: 10시트
                  - generic [ref=e98]: 6,630원
                - button "20시트 12,500원" [ref=e99] [cursor=pointer]:
                  - generic [ref=e100]: 20시트
                  - generic [ref=e101]: 12,500원
                - button "50시트 29,540원" [ref=e102] [cursor=pointer]:
                  - generic [ref=e103]: 50시트
                  - generic [ref=e104]: 29,540원
                - button "100시트 57,200원" [ref=e105] [cursor=pointer]:
                  - generic [ref=e106]: 100시트
                  - generic [ref=e107]: 57,200원
                - button "200시트 105,120원" [ref=e108] [cursor=pointer]:
                  - generic [ref=e109]: 200시트
                  - generic [ref=e110]: 105,120원
                - button "500시트 203,800원" [ref=e111] [cursor=pointer]:
                  - generic [ref=e112]: 500시트
                  - generic [ref=e113]: 203,800원
                - button "1,000시트 331,200원" [ref=e114] [cursor=pointer]:
                  - generic [ref=e115]: 1,000시트
                  - generic [ref=e116]: 331,200원
            ...
            - generic [ref=e126]:
              - paragraph [ref=e128]:
                - strong [ref=e129]: 3,420원
              - paragraph [ref=e130]: (1매당 57원)
            - generic [ref=e131]:
              - generic [ref=e132]:
      ...
      - generic [ref=e596]:
        - generic [ref=e597]:
          - img "text" [ref=e598]
          - generic [ref=e599]:
            - heading "원형 시트 스티커 FAQ" [level=2] [ref=e600]
            - paragraph [ref=e601]:
        ...
        - generic [ref=e603]:
          - generic [ref=e604]:
            - generic [ref=e605] [cursor=pointer]:
              - heading "원형 시트 스티커란 무엇인가요?" [level=3] [ref=e606]
              - paragraph [ref=e609]: 원형 시트 스티커는 여러 개의 원형 스티커를 한 장의 시트에 배치해 제작하는 스티커입니다. 각 스티커는 키스컷 방식으로 제작되어 시트는 그대로 유지되며, 스티커를 한 장씩 쉽게 떼어 사용할 수 있습니다.
            - button [ref=e610] [cursor=pointer]:
              - img [ref=e611]
          - generic [ref=e613]:
            - generic [ref=e614] [cursor=pointer]:
              - heading "원형 시트 스티커는 방수 및 내구성이 있나요?" [level=3] [ref=e615]
              - paragraph [ref=e616]: 네. 머스티커의 원형 시트 스티커는 방수 기능이 있는 PVC 소재로 제작됩니다. 둥근 형태로 가장자리가 깔끔하게 마감되어 다양한 용도로 편리하게 사용할 수 있습니다. 다만 날카로운 물체나 강한 마찰에는 긁힘이 생길 수 있으니 주의해 주세요.
            - button [ref=e617] [cursor=pointer]:
              - img [ref=e618]
          - generic [ref=e620]:
            - generic [ref=e621] [cursor=pointer]:
              - heading "한 장의 시트에 여러 가지 원형 디자인을 넣을 수 있나요?" [level=3] [ref=e622]
              - paragraph [ref=e623]: 아니요. 원형 시트 스티커는 하나의 디자인이 시트 전체에 반복 배치되어 제작됩니다. 모든 스티커가 동일한 크기와 간격으로 배치되어 깔끔하게 제작됩니다.
            - button [ref=e624] [cursor=pointer]:
              - img [ref=e625]
          - generic [ref=e627]:
            - generic [ref=e628] [cursor=pointer]:
              - heading "원형 스티커는 정확한 원형으로 제작되나요?" [level=3] [ref=e629]
              - paragraph [ref=e630]: 네. 모든 원형 스티커는 깔끔한 원형으로 제작됩니다. 디자인이 중앙에 맞게 배치되어 좌우 균형이 잘 잡힌 형태로 완성됩니다.
            - button [ref=e631] [cursor=pointer]:
              - img [ref=e632]
          - generic [ref=e634]:
            - generic [ref=e635] [cursor=pointer]:
              - heading "원형 시트 스티커는 어떤 소재를 선택할 수 있나요?" [level=3] [ref=e636]
              - paragraph [ref=e637]: 원형 시트 스티커는 PVC(백색), 투명, 홀로그램 소재로 제작할 수 있습니다. 선명한 색감을 원한다면 PVC(백색), 깔끔하고 자연스러운 느낌을 원한다면 투명, 반짝이는 효과를 원한다면 홀로그램을 추천합니다.
