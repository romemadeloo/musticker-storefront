...
- Name: pricing/price-interpolation.spec.ts >> pricing interpolation die-cut-sticker >> MS-PRC-INT-die-cut-sticker area 154062 (317x486) interpolates between 152100 and 156025
- Location: tests/e2e/pricing/price-interpolation.spec.ts:103:7

# Error details

```
Error: die-cut-sticker area 154062 (317x486) qty 300 lower bound total should be the UNROUNDED 152100 row product: served pricing_id=48 "diecut/kisscut - 9/9/2026"

expect(received).toBeCloseTo(expected, precision)

Expected: 844499.9628
Received: 844520.04

Expected precision:    4
Expected difference: < 0.00005
Received difference:   20.07720000005793
```
