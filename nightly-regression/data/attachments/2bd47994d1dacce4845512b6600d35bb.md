...
- Name: regression/error-pages.spec.ts >> storefront v2 error handling >> MS-V2-043 unknown route redirects safely instead of showing a broken page
- Location: tests/e2e/regression/error-pages.spec.ts:11:3

# Error details

```
Error: unknown route should not return a server error status
...
- Array []
+ Array [
+   "404 https://www.musticker.com/kr/this-page-does-not-exist-e2e-check",
+ ]
```
...
- main [ref=e3]:
  ...
  - paragraph [ref=e5]: "404"
  - heading "앗! 페이지를 찾을 수 없습니다." [level=1] [ref=e6]
  - paragraph [ref=e7]: 찾으시는 페이지가 이동되었거나 더 이상 제공되지 않을 수 있습니다. 원하시는 곳으로 다시 안내해 드릴게요.
