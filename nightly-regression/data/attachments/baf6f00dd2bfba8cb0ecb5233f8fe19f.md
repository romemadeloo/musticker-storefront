...
- generic [ref=e3]:
  ...
  - main [ref=e30]:
    - generic [ref=e31]:
      ...
      - generic [ref=e174]:
        - heading "0개 사진 후기가 보장해요" [level=2] [ref=e175]
        - paragraph [ref=e176]: 직접 사용한 고객들의 생생한 리뷰를 확인해보세요. 리얼 사용 이미지와 함께 실제 만족도를 보여드립니다.
        - generic [ref=e177]:
          - button "이전 리뷰" [disabled] [ref=e178] [cursor=pointer]:
            - img [ref=e179]
            - generic [ref=e181]: 이전 리뷰
          - button "다음 리뷰" [disabled] [ref=e182] [cursor=pointer]:
            - img [ref=e183]
      ...
      - generic [ref=e187]:
        - generic [ref=e188]:
          - img "text" [ref=e189]
          - generic [ref=e190]:
            - heading "투명 스티커 FAQ" [level=2] [ref=e191]
            - paragraph [ref=e192]:
              - text: 멤버십, 주문, 디자인 파일 업로드, 인쇄, 결제, 반품·환불에 대한 자세한 내용은 자주 묻는
              - link "질문(FAQ) 페이지에서 확인해 주세요" [ref=e193] [cursor=pointer]:
                - /url: https://www.musticker.com/faq
              - text: .
        - generic [ref=e194]:
          - generic [ref=e195]:
            - generic [ref=e196] [cursor=pointer]:
              - heading "투명 스티커란 무엇인가요?" [level=3] [ref=e197]
              - paragraph [ref=e200]: 투명 스티커는 투명 PVC 용지에 인쇄되어 부착한 표면이 자연스럽게 비치는 스티커입니다. 유리, 창문, 패키지 등 다양한 표면에 잘 어우러져 깔끔하고 세련된 느낌을 연출할 수 있습니다.
            - button [ref=e201] [cursor=pointer]:
              - img [ref=e202]
          - generic [ref=e204]:
            - generic [ref=e205] [cursor=pointer]:
              - heading "투명 스티커는 어떤 표면에 부착하기 좋나요?" [level=3] [ref=e206]
              - paragraph [ref=e207]: 투명 스티커는 유리, 플라스틱, 아크릴 등 매끄러운 표면에 부착하기 좋습니다. 병, 용기, 쇼윈도 등 다양한 곳에 많이 사용됩니다.
            - button [ref=e208] [cursor=pointer]:
              - img [ref=e209]
          - generic [ref=e211]:
            - generic [ref=e212] [cursor=pointer]:
              - heading "투명 스티커용 디자인은 어떻게 준비해야 하나요?" [level=3] [ref=e213]
              - paragraph [ref=e214]: 투명하게 표현할 부분은 디자인에서 비워 두어야 합니다. 백색 인쇄가 필요한 경우에는 해당 영역을 함께 표시해 주세요.
            - button [ref=e215] [cursor=pointer]:
              - img [ref=e216]
          - generic [ref=e218]:
            - generic [ref=e219] [cursor=pointer]:
              - heading "투명 스티커는 색상이 다르게 보일 수 있나요?" [level=3] [ref=e220]
              - paragraph [ref=e221]: 네. 백색 인쇄 없이 제작하는 경우에는 색상이 옅게 표현될 수 있으며, 특히 어두운 표면에 부착하면 색상이 더욱 연하게 보일 수 있습니다.
            - button [ref=e222] [cursor=pointer]:
              - img [ref=e223]
          - generic [ref=e225]:
            - generic [ref=e226] [cursor=pointer]:
              - heading "투명 스티커는 방수 및 내구성이 있나요?" [level=3] [ref=e227]
              - paragraph [ref=e228]: 네. 머스티커의 투명 스티커는 내구성이 뛰어난 PVC 용지에 인쇄되어 방수와 습기에 강하며, 선명한 인쇄 상태를 오래 유지합니다. 다만 날카로운 물체나 강한 마찰에는 긁힘이 생길 수 있으니 주의해 주세요.
            - button [ref=e229] [cursor=pointer]:
              - img [ref=e230]
        - generic [ref=e232]:
          - generic [ref=e233]:
            - heading "궁금한 점이 더 있으신가요?" [level=4] [ref=e234]
            - paragraph [ref=e235]: 원하시는 답변을 찾지 못하셨다면 언제든지 문의해 주세요.
          - button "문의하기" [ref=e236] [cursor=pointer]:
            - generic [ref=e237]: 문의하기
    - navigation "네이버 톡톡으로 문의하기" [ref=e238]:
      - link "카카오채널로 문의하기" [ref=e239] [cursor=pointer]:
        ...
        - img [ref=e241]
      - link "네이버 톡톡 으로 문의하기" [ref=e242] [cursor=pointer]:
        ...
        - img [ref=e244]
      - generic "이메일로 문의하기" [ref=e245] [cursor=pointer]:
        - generic:
          - generic:
            - generic:
              - img
  ...
  - contentinfo [ref=e248]:
    - generic [ref=e249]:
      - generic [ref=e250]:
        - heading "MUSTICKER / 머스티커" [level=2] [ref=e251]
        - paragraph [ref=e252]: "상호명: (주)글로픽스"
        - paragraph [ref=e253]: "사업자등록번호 : 877-88-03313 통신판매업신고 : 2026-부산해운대-0792호"
        - paragraph [ref=e254]: "대표이사 : 여일석 주소 : 부산광역시 해운대구 해운대해변로 203 오션타워 1014호"
        - paragraph [ref=e255]: "호스팅사업자 : 아마존웹서비시즈(Amazon Web Services)"
        - paragraph [ref=e256]:
          - generic [ref=e257]: ⓒ 2026. All rights reserved.
          - generic [ref=e258]: "판매: sales@musticker.com"
          - link "이용약관" [ref=e259] [cursor=pointer]:
            - /url: /kr/terms-of-use
          - link "개인정보처리방침" [ref=e260] [cursor=pointer]:
            - /url: /kr/privacy-policy
          - generic [ref=e261] [cursor=pointer]: 사업자정보확인
          - link "오픈소스 라이선스" [ref=e262] [cursor=pointer]:
      ...
      - generic [ref=e264]:
        ...
        - generic [ref=e268]:
          ...
          - link "자주 묻는 질문" [ref=e270] [cursor=pointer]:
            - /url: /kr/faq
        - generic [ref=e271]:
          - generic [ref=e272]: "Follow us at:"
          - generic [ref=e273]:
            - link "instagram icon" [ref=e274] [cursor=pointer]:
              - /url: https://www.instagram.com/musticker_official/
              - img "instagram icon"
            - link "youtube icon" [ref=e275] [cursor=pointer]:
