...
- Name: pricing/price-interpolation.spec.ts >> pricing interpolation clear-roll >> MS-PRC-INT-clear-roll area 312 (13x24) interpolates between 225 and 400
- Location: tests/e2e/pricing/price-interpolation.spec.ts:103:7

# Error details

```
Error: clear-roll area 312 (13x24) qty 300 upper bound total should be the UNROUNDED 400 row product: served pricing_id=54 "clear roll - 9/10/2026"

expect(received).toBeCloseTo(expected, precision)

Expected: 24000
Received: 24099.999996

Expected precision:    4
Expected difference: < 0.00005
Received difference:   99.99999599999865
```
