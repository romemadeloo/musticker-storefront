...
```
Error: Size guide image 0 alt text is a raw, untranslated i18n key: "product.sizes.small40x40.label"

expect(received).not.toMatch(expected)

Expected pattern: not /^product\.sizes\./
Received string:      "product.sizes.small40x40.label"
```
    ...
    - generic [ref=e31]:
      ...
      - generic [ref=e560]:
        - generic [ref=e561]:
          - img "text" [ref=e562]
          - generic [ref=e563]:
            - heading "원형 시트 스티커 FAQ" [level=2] [ref=e564]
            - paragraph [ref=e565]:
        ...
        - generic [ref=e567]:
          - generic [ref=e568]:
            - generic [ref=e569] [cursor=pointer]:
              - heading "원형 시트 스티커란 무엇인가요?" [level=3] [ref=e570]
              - paragraph [ref=e573]: 원형 시트 스티커는 여러 개의 원형 스티커를 한 장의 시트에 배치해 제작하는 스티커입니다. 각 스티커는 키스컷 방식으로 제작되어 시트는 그대로 유지되며, 스티커를 한 장씩 쉽게 떼어 사용할 수 있습니다.
            - button [ref=e574] [cursor=pointer]:
              - img [ref=e575]
          - generic [ref=e577]:
            - generic [ref=e578] [cursor=pointer]:
              - heading "원형 시트 스티커는 방수 및 내구성이 있나요?" [level=3] [ref=e579]
              - paragraph [ref=e580]: 네. 머스티커의 원형 시트 스티커는 방수 기능이 있는 PVC 소재로 제작됩니다. 둥근 형태로 가장자리가 깔끔하게 마감되어 다양한 용도로 편리하게 사용할 수 있습니다. 다만 날카로운 물체나 강한 마찰에는 긁힘이 생길 수 있으니 주의해 주세요.
            - button [ref=e581] [cursor=pointer]:
              - img [ref=e582]
          - generic [ref=e584]:
            - generic [ref=e585] [cursor=pointer]:
              - heading "한 장의 시트에 여러 가지 원형 디자인을 넣을 수 있나요?" [level=3] [ref=e586]
              - paragraph [ref=e587]: 아니요. 원형 시트 스티커는 하나의 디자인이 시트 전체에 반복 배치되어 제작됩니다. 모든 스티커가 동일한 크기와 간격으로 배치되어 깔끔하게 제작됩니다.
            - button [ref=e588] [cursor=pointer]:
              - img [ref=e589]
          - generic [ref=e591]:
            - generic [ref=e592] [cursor=pointer]:
              - heading "원형 스티커는 정확한 원형으로 제작되나요?" [level=3] [ref=e593]
              - paragraph [ref=e594]: 네. 모든 원형 스티커는 깔끔한 원형으로 제작됩니다. 디자인이 중앙에 맞게 배치되어 좌우 균형이 잘 잡힌 형태로 완성됩니다.
            - button [ref=e595] [cursor=pointer]:
              - img [ref=e596]
          - generic [ref=e598]:
            - generic [ref=e599] [cursor=pointer]:
              - heading "원형 시트 스티커는 어떤 소재를 선택할 수 있나요?" [level=3] [ref=e600]
              - paragraph [ref=e601]: 원형 시트 스티커는 PVC(백색), 투명, 홀로그램 소재로 제작할 수 있습니다. 선명한 색감을 원한다면 PVC(백색), 깔끔하고 자연스러운 느낌을 원한다면 투명, 반짝이는 효과를 원한다면 홀로그램을 추천합니다.
