...
// second check matters for the CSVs too: five shape products share pricing_id 25, so their exports
// have to agree with each other or at most one of them can be correct.
import { test, expect } from '@playwright/test';

import { fetchQuotation, storedRow, tableIdentity } from '../../fixtures/pricing/pricing-api.js';
import { pricingProducts, productsSharingPricingId } from '../../fixtures/pricing/pricing-products.js';
