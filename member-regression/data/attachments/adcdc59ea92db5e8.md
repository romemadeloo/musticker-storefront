...
Locator: getByRole('dialog').filter({ hasText: /\uc7a5\ubc14\uad6c\ub2c8 \ubbf8\ub9ac\ubcf4\uae30|Cart Preview/i }).getByRole('article').filter({ hasText: 'Die Cut Sticker' }).filter({ hasText: /Size:|Quantity:|\uc0ac\uc774\uc988:|\uc218\ub7c9:/i }).first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByRole('dialog').filter({ hasText: /\uc7a5\ubc14\uad6c\ub2c8 \ubbf8\ub9ac\ubcf4\uae30|Cart Preview/i }).getByRole('article').filter({ hasText: 'Die Cut Sticker' }).filter({ hasText: /Size:|Quantity:|\uc0ac\uc774\uc988:|\uc218\ub7c9:/i }).first()
            ...
            - generic [ref=e31]:
              ...
              - complementary [ref=e56]:
                ...
                - list [ref=e116]:
                  ...
                  - listitem [ref=e119]: "도착 예정일: 07.16 (목) · CJ 대한통운"
          ...
          - generic [ref=e592]:
            ...
            - generic [ref=e596]:
              ...
              - link "자주 묻는 질문" [ref=e598] [cursor=pointer]:
                - /url: /kr/faq
    - button "KR" [ref=e599] [cursor=pointer]
  - dialog [ref=e601]:
    - banner [ref=e602]:
      - heading "장바구니 미리보기 (1)" [level=3] [ref=e603]
      - button "쇼핑 계속하기" [ref=e604] [cursor=pointer]:
        - generic [ref=e605]:
          - paragraph [ref=e606]: 쇼핑 계속하기
          - img [ref=e607]
    - article [ref=e612]:
      - generic [ref=e613]:
        - img "01-artwork-upload-die-cut-sticker-071526041144.png" [ref=e615]
        - generic [ref=e616]:
          - heading "자유형 스티커" [level=4] [ref=e617]
          - paragraph [ref=e618]: "사이즈: 75x75mm"
          - paragraph [ref=e619]: "수량: 10개"
      - generic [ref=e620]:
        - strong [ref=e621]: 6,600원
        - generic [ref=e622]:
          - button "상품 수정" [ref=e623] [cursor=pointer]:
            - img [ref=e624]
            - generic [ref=e626]: 상품 수정
          - button "상품 삭제" [ref=e627] [cursor=pointer]:
            - img [ref=e628]
            - generic [ref=e630]: 상품 삭제
    - contentinfo [ref=e631]:
      - generic [ref=e632]:
        - paragraph [ref=e633]:
          - generic [ref=e634]: 합계
          - strong [ref=e635]: 6,600원
        - generic [ref=e636]:
          - paragraph [ref=e637]: 참고
          - paragraph [ref=e638]: 배송비 및 할인 내역은 결제 시 적용됩니다.
      - generic [ref=e639]:
        - button "장바구니 보기" [ref=e640] [cursor=pointer]:
          - generic [ref=e641]: 장바구니 보기
        - button "주문하기" [ref=e642] [cursor=pointer]:
          - generic [ref=e643]:
            - img [ref=e644]
            - text: 주문하기
```
