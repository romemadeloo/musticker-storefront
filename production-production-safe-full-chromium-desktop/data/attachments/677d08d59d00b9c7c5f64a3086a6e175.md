...
Call log:
  - waiting for getByTestId('product-category-options').or(getByRole('complementary').filter({ hasText: /\uc0ac\uc774\uc988|\uc218\ub7c9|Size|Quantity/i })).first().getByRole('button', { name: /^20\s*(?:\S+)?\s*[\d,]+\uc6d0/u }).first()
    ...
    - generic [ref=e31]:
          ...
          - complementary [ref=e61]:
            ...
            - generic [ref=e71]:
              ...
              - generic [ref=e75]:
                ...
                - button "중형 50x50" [active] [ref=e79] [cursor=pointer]:
                  - generic [ref=e80]: 중형
            ...
            - list [ref=e106]:
              ...
              - listitem [ref=e109]: "도착 예정일: 08.31 (월) · CJ 대한통운"
      ...
      - generic [ref=e146]:
        - generic [ref=e147]:
          ...
          - generic [ref=e164]:
            - button "이전 리뷰" [ref=e165] [cursor=pointer]:
              - img [ref=e166]
