...
- Name: pricing/price-interpolation.spec.ts >> pricing interpolation hologram-sticker >> MS-PRC-INT-hologram-sticker area 162 (9x18) interpolates between 100 and 225
- Location: tests/e2e/pricing/price-interpolation.spec.ts:103:7

# Error details

```
Error: hologram-sticker area 162 (9x18) qty 300 lower bound total should be the UNROUNDED 100 row product: served pricing_id=50 "hologram sticker - 9/9/2026"
...
Received difference:   5139.999899999999
```
