...
- Name: pricing/price-table.spec.ts >> pricing table oval-sticker >> MS-PRC-oval-sticker area 144400 (380x380) matches stickers/oval-sticker.csv
- Location: tests/e2e/pricing/price-table.spec.ts:59:7

# Error details

```
Error: oval-sticker area 144400 (380x380): served pricing_id=48 "diecut/kisscut - 9/9/2026"
