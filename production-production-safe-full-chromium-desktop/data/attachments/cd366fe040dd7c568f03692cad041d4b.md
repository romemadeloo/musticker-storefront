...
- Name: pricing/price-interpolation.spec.ts >> pricing interpolation rounded-sticker >> MS-PRC-INT-rounded-sticker area 162 (9x18) interpolates between 100 and 225
- Location: tests/e2e/pricing/price-interpolation.spec.ts:103:7

# Error details

```
Error: rounded-sticker area 162 (9x18) qty 300 upper bound total should be the UNROUNDED 225 row product: served pricing_id=48 "diecut/kisscut - 9/9/2026"
