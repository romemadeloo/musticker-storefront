...
- Name: purchasing/sheet-sticker-size-rules.spec.ts >> storefront v2 sheet sticker size rules (minimum two stickers per sheet) >> MS-V2-075 정사각형 시트 스티커 preset sizes match the shape family table and all fit at least two per sheet
- Location: tests/e2e/purchasing/sheet-sticker-size-rules.spec.ts:113:5

# Error details

```
Error: Expected the sheet to report 6 stickers per sheet
    ...
    - generic [ref=e31]:
      - generic [ref=e33]:
        ...
        - generic [ref=e36]:
          - generic [ref=e39]:
            - generic [ref=e40]:
              - heading "정사각형 시트 스티커" [level=1] [ref=e41]
              - paragraph [ref=e42]: 한 장의 시트에 정돈되어 사용과 보관이 편리한 정사각형 시트 스티커
            - img "정사각형 시트 스티커 preview poster" [ref=e44]
            - generic [ref=e46]:
          ...
          - complementary [ref=e65]:
            ...
            - generic [ref=e75]:
              ...
              - generic [ref=e79]:
                ...
                - button "중형 50x50" [active] [ref=e83] [cursor=pointer]:
                  - generic [ref=e84]: 중형
            ...
            - generic [ref=e98]:
              ...
              - generic [ref=e100]:
                - button "5시트 3,450원" [ref=e101] [cursor=pointer]:
                  - generic [ref=e102]: 5시트
                  - generic [ref=e103]: 3,450원
                - button "10시트 6,600원" [ref=e104] [cursor=pointer]:
                  - generic [ref=e105]: 10시트
                  - generic [ref=e106]: 6,600원
                - button "20시트 12,800원" [ref=e107] [cursor=pointer]:
                  - generic [ref=e108]: 20시트
                  - generic [ref=e109]: 12,800원
                - button "50시트 31,000원" [ref=e110] [cursor=pointer]:
                  - generic [ref=e111]: 50시트
                  - generic [ref=e112]: 31,000원
                - button "100시트 60,600원" [ref=e113] [cursor=pointer]:
                  - generic [ref=e114]: 100시트
                  - generic [ref=e115]: 60,600원
                - button "200시트 105,300원" [ref=e116] [cursor=pointer]:
                  - generic [ref=e117]: 200시트
                  - generic [ref=e118]: 105,300원
                - button "500시트 185,000원" [ref=e119] [cursor=pointer]:
                  - generic [ref=e120]: 500시트
                  - generic [ref=e121]: 185,000원
                - button "1,000시트 250,000원" [ref=e122] [cursor=pointer]:
                  - generic [ref=e123]: 1,000시트
                  - generic [ref=e124]: 250,000원
            ...
            - list [ref=e154]:
              ...
              - listitem [ref=e157]: "도착 예정일: 09.14 (월) · CJ 대한통운"
      ...
      - generic [ref=e160]:
        ...
        - article [ref=e169]:
          - img "빠르고 간편한 부착" [ref=e170]
          - heading "빠르고 간편한 부착" [level=4] [ref=e171]
          - paragraph [ref=e172]: 스티커가 시트에서 쉽게 떼어져 원하는 곳에 빠르고 간편하게 부착할 수 있습니다.
      - generic [ref=e174]:
        - article [ref=e175]:
          - generic [ref=e178]:
      ...
      - generic [ref=e608]:
        - generic [ref=e609]:
          - img "text" [ref=e610]
          - generic [ref=e611]:
            - heading "정사각형 시트 스티커 FAQ" [level=2] [ref=e612]
            - paragraph [ref=e613]:
        ...
        - generic [ref=e615]:
          - generic [ref=e616]:
            - generic [ref=e617] [cursor=pointer]:
              - heading "정사각형 시트 스티커란 무엇인가요?" [level=3] [ref=e618]
              - paragraph [ref=e621]: 정사각형 시트 스티커는 여러 개의 정사각형 스티커를 한 장의 시트에 배치해 제작하는 스티커입니다. 각 스티커는 키스컷 방식으로 제작되어 시트는 그대로 유지되며, 스티커를 한 장씩 쉽게 떼어 사용할 수 있습니다.
            - button [ref=e622] [cursor=pointer]:
              - img [ref=e623]
          - generic [ref=e625]:
            - generic [ref=e626] [cursor=pointer]:
              - heading "정사각형 시트 스티커는 어떤 소재로 제작되나요?" [level=3] [ref=e627]
              - paragraph [ref=e628]: 머스티커의 정사각형 시트 스티커는 방수 기능이 있는 PVC 소재로 제작되어 인쇄가 선명하고 형태가 안정적입니다. 다만 날카로운 물체나 강한 마찰에는 긁힘이 생길 수 있으니 주의해 주세요.
            - button [ref=e629] [cursor=pointer]:
              - img [ref=e630]
          - generic [ref=e632]:
            - generic [ref=e633] [cursor=pointer]:
              - heading "정사각형 시트 스티커도 둥근 모서리로 제작할 수 있나요?" [level=3] [ref=e634]
              - paragraph [ref=e635]: 아니요. 정사각형 시트 스티커는 직각 모서리로 제작됩니다. 둥근 모서리를 원하신다면 둥근사각형 시트 스티커를 선택해 주세요.
            - button [ref=e636] [cursor=pointer]:
              - img [ref=e637]
          - generic [ref=e639]:
            - generic [ref=e640] [cursor=pointer]:
              - heading "한 장의 시트에 있는 정사각형 스티커는 모두 같은 디자인인가요?" [level=3] [ref=e641]
              - paragraph [ref=e642]: 네. 정사각형 시트 스티커는 하나의 디자인이 시트 전체에 반복 배치되어 제작됩니다. 모든 스티커가 동일한 크기와 모양, 색상으로 제작됩니다.
            - button [ref=e643] [cursor=pointer]:
              - img [ref=e644]
          - generic [ref=e646]:
            - generic [ref=e647] [cursor=pointer]:
              - heading "정사각형 시트 스티커는 어떤 소재를 선택할 수 있나요?" [level=3] [ref=e648]
              - paragraph [ref=e649]: 정사각형 시트 스티커는 PVC(백색), 투명, 홀로그램 소재로 제작할 수 있습니다. 선명한 색감을 원한다면 PVC(백색), 깔끔하고 자연스러운 느낌을 원한다면 투명, 반짝이는 효과를 원한다면 홀로그램을 추천합니다.
