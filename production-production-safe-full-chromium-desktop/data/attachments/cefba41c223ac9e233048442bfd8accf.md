...
- Name: pricing/price-interpolation.spec.ts >> pricing interpolation oval-roll >> MS-PRC-INT-oval-roll area 56112 (168x334) interpolates between 55225 and 57000
- Location: tests/e2e/pricing/price-interpolation.spec.ts:103:7

# Error details

```
Error: oval-roll area 56112 (168x334) qty 300 lower bound total should be the UNROUNDED 55225 row product: served pricing_id=53 "diecut/kisscut roll - 9/10/2026"
