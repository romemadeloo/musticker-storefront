...
- Name: pricing/price-interpolation.spec.ts >> pricing interpolation circle-sticker >> MS-PRC-INT-circle-sticker quantity 7500 interpolates between rungs 5000 and 10000
- Location: tests/e2e/pricing/price-interpolation.spec.ts:160:7

# Error details

```
Error: circle-sticker 385x385 qty=7500: pricing API returned 403 Forbidden for https://api.musticker.com/index.php/sys/kr/pricing/quotation/circle-sticker?width=385&height=385&quantity=7500&debug=1 on all 5 attempts over ~29s.
