...
- Name: edgecases/storefront-edgecases.spec.ts >> production-safe storefront edge cases >> browser back and forward preserve cart state before checkout submission
- Location: tests/e2e/edgecases/storefront-edgecases.spec.ts:213:3
