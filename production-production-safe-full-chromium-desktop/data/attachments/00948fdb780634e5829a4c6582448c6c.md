...
- Name: pricing/price-table.spec.ts >> pricing table paper-roll >> MS-PRC-paper-roll area 8100 (90x90) matches roll-stickers/paper-roll.csv
- Location: tests/e2e/pricing/price-table.spec.ts:59:7

# Error details

```
Error: paper-roll area 8100 (90x90): served pricing_id=55 "paper roll - 9/10/2026"
