...
- Name: pricing/price-table.spec.ts >> pricing table hologram-sticker >> MS-PRC-hologram-sticker area 115600 (340x340) matches stickers/hologram-sticker.csv
- Location: tests/e2e/pricing/price-table.spec.ts:59:7

# Error details

```
Error: hologram-sticker area 115600 (340x340): served pricing_id=50 "hologram sticker - 9/9/2026"

expect(received).toMatch(expected)

Expected pattern: /^Hologram\b/
Received string:  "hologram sticker - 9/9/2026"
```
