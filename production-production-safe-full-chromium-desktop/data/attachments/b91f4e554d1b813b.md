...
- Name: purchasing/product-config.spec.ts >> product configuration >> configures die-cut sticker size and quantity then opens upload modal
- Location: tests/e2e/purchasing/product-config.spec.ts:8:3
