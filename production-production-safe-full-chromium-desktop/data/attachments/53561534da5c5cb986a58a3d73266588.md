...
- Name: pricing/price-table.spec.ts >> pricing table oval-roll >> MS-PRC-oval-roll area 52900 (230x230) matches roll-stickers/oval-roll.csv
- Location: tests/e2e/pricing/price-table.spec.ts:59:7

# Error details

```
Error: oval-roll area 52900 (230x230): served pricing_id=53 "diecut/kisscut roll - 9/10/2026"
