    ...
    - generic [ref=e48]:
      ...
      - generic [ref=e577]:
        - generic [ref=e578]:
          - img "text" [ref=e579]
          - generic [ref=e580]:
            - heading "타원형 시트 스티커 FAQ" [level=2] [ref=e581]
            - paragraph [ref=e582]:
        ...
        - generic [ref=e584]:
          - generic [ref=e585]:
            - generic [ref=e586] [cursor=pointer]:
              - heading "타원형 시트 스티커란 무엇인가요?" [level=3] [ref=e587]
              - paragraph [ref=e590]: 타원형 시트 스티커는 여러 개의 타원형 스티커를 한 장의 시트에 배치해 제작하는 스티커입니다. 각 스티커는 키스컷 방식으로 제작되어 시트는 그대로 유지되며, 스티커를 한 장씩 쉽게 떼어 사용할 수 있습니다.
            - button [ref=e591] [cursor=pointer]:
              - img [ref=e592]
          - generic [ref=e594]:
            - generic [ref=e595] [cursor=pointer]:
              - heading "타원형 시트 스티커는 방수 및 내구성이 있나요?" [level=3] [ref=e596]
              - paragraph [ref=e597]: 네. 머스티커의 타원형 시트 스티커는 방수 기능이 있으며, 내구성이 뛰어난 PVC 소재로 제작됩니다. 다만 날카로운 물체나 강한 마찰에는 긁힘이 생길 수 있으니 주의해 주세요.
            - button [ref=e598] [cursor=pointer]:
              - img [ref=e599]
          - generic [ref=e601]:
            - generic [ref=e602] [cursor=pointer]:
              - heading "한 장의 시트에는 타원형 스티커를 몇 개까지 제작할 수 있나요?" [level=3] [ref=e603]
              - paragraph [ref=e604]: 선택한 스티커 사이즈와 시트 크기에 따라 제작 가능한 수량이 달라집니다. 작은 스티커는 한 장의 시트에 더 많이 배치할 수 있으며, 큰 스티커는 제작 가능한 수량이 줄어듭니다.
            - button [ref=e605] [cursor=pointer]:
              - img [ref=e606]
          - generic [ref=e608]:
            - generic [ref=e609] [cursor=pointer]:
              - heading "타원형 시트 스티커는 어떤 소재를 선택할 수 있나요?" [level=3] [ref=e610]
              - paragraph [ref=e611]: 타원형 시트 스티커는 PVC(백색), 투명, 홀로그램 소재로 제작할 수 있습니다. 제품 라벨부터 홍보용 스티커까지 용도에 맞는 소재를 선택해 원하는 분위기를 연출할 수 있습니다.
            - button [ref=e612] [cursor=pointer]:
              - img [ref=e613]
          - generic [ref=e615]:
            - generic [ref=e616] [cursor=pointer]:
              - heading "타원형 스티커는 가로형과 세로형 모두 제작할 수 있나요?" [level=3] [ref=e617]
              - paragraph [ref=e618]: 네. 디자인에 맞게 가로형 또는 세로형으로 제작할 수 있습니다. 가로형은 가로로 넓은 디자인에, 세로형은 세로로 긴 디자인에 적합합니다.
