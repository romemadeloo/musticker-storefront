...
- Name: auth/registration.spec.ts >> storefront registration >> MS-V2-082 password below the stated policy is rejected @validation
- Location: tests/e2e/auth/registration.spec.ts:58:3
...
Locator: getByTestId('auth-register-password-input-control')
Expected: "text"
Timeout: 1000ms
...
Call log:
  ...
  - waiting for getByTestId('auth-register-password-input-control')
    3 × locator resolved to <input value="" type="password" placeholder="비밀번호 입력" class="ui-input-field" data-testid="auth-register-password-input-control"/>
...
- Array []
+ Array [
+   "502 https://www.musticker.com/_nuxt/DJx-fFNv.js",
+ ]
```
