...
- Name: pricing/price-table.spec.ts >> pricing table die-cut-sticker >> MS-PRC-die-cut-sticker area 50625 (225x225) matches stickers/die-cut-sticker.csv
- Location: tests/e2e/pricing/price-table.spec.ts:59:7

# Error details

```
Error: die-cut-sticker area 50625 (225x225): served pricing_id=48 "diecut/kisscut - 9/9/2026"

expect(received).toMatch(expected)

Expected pattern: /^Die Cut\b/
