...
- Name: pricing/price-table.spec.ts >> pricing table rounded-sticker >> MS-PRC-rounded-sticker area 330625 (575x575) matches stickers/rounded-sticker.csv
- Location: tests/e2e/pricing/price-table.spec.ts:59:7

# Error details

```
Error: rounded-sticker area 330625 (575x575): served pricing_id=48 "diecut/kisscut - 9/9/2026"
