...
- Name: validation/auth-validation.spec.ts >> auth validation and error handling >> non-member order lookup requires email and order number
- Location: tests/e2e/validation/auth-validation.spec.ts:32:3
...
+   "500 https://api.musticker.com/index.php/sys/kr/user/me?t=1785879872293",
