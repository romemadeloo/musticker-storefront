...
- Name: pricing/price-interpolation.spec.ts >> pricing interpolation die-cut-sticker >> MS-PRC-INT-die-cut-sticker area 760 (20x38) interpolates between 625 and 900
- Location: tests/e2e/pricing/price-interpolation.spec.ts:103:7

# Error details

```
Error: die-cut-sticker area 760 (20x38) qty 300 lower bound total should be the UNROUNDED 625 row product: served pricing_id=48 "diecut/kisscut - 9/9/2026"

expect(received).toBeCloseTo(expected, precision)

Expected: 32199.999375
Received: 32199.9375

Expected precision:    4
Expected difference: < 0.00005
Received difference:   0.06187499999941792
```
