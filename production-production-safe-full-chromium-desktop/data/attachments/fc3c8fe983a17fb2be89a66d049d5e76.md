...
- Name: pricing/price-interpolation.spec.ts >> pricing interpolation rounded-roll >> MS-PRC-INT-rounded-roll area 16262 (94x173) interpolates between 15625 and 16900
- Location: tests/e2e/pricing/price-interpolation.spec.ts:103:7

# Error details

```
Error: rounded-roll area 16262 (94x173) qty 300 upper bound total should be the UNROUNDED 16900 row product: served pricing_id=53 "diecut/kisscut roll - 9/10/2026"
