    ...
    - generic [ref=e48]:
      - generic [ref=e50]:
        ...
        - generic [ref=e53]:
          - generic [ref=e54]:
            - generic [ref=e55]:
              - heading "타원형 시트 스티커" [level=1] [ref=e56]
              - paragraph [ref=e57]: 한 장의 시트에 정돈되어 깔끔하게 부착하기 좋은 타원형 시트 스티커
            - img "타원형 시트 스티커 preview poster" [ref=e59]
            - generic [ref=e61]:
              - button "소형 50x25 product.sizes.small50x25.label 작고 귀여운 크기로 휴대폰 케이스나 헬멧에 딱!" [ref=e62] [cursor=pointer]:
                - heading "소형 50x25" [level=4] [ref=e63]
                - img "product.sizes.small50x25.label" [ref=e64]
                - paragraph [ref=e65]: 작고 귀여운 크기로 휴대폰 케이스나 헬멧에 딱!
              - button "중형 75x50 product.sizes.medium75x50.label 텀블러·노트북에 잘 어울려요. 가장 인기 있는 사이즈예요." [ref=e66] [cursor=pointer]:
                - heading "중형 75x50" [level=4] [ref=e67]
                - img "product.sizes.medium75x50.label" [ref=e68]
                - paragraph [ref=e69]: 텀블러·노트북에 잘 어울려요. 가장 인기 있는 사이즈예요.
              - button "대형 100x75 product.sizes.large100x75.label 보드나 캐리어에 붙이면 눈에 잘 띄는 크기예요." [ref=e70] [cursor=pointer]:
                - heading "대형 100x75" [level=4] [ref=e71]
                - img "product.sizes.large100x75.label" [ref=e72]
                - paragraph [ref=e73]: 보드나 캐리어에 붙이면 눈에 잘 띄는 크기예요.
              - button "초대형 125x100 product.sizes.extraLarge125x100.label 차·아이스박스·공구함에도 딱 맞는 넉넉한 크기예요." [ref=e74] [cursor=pointer]:
                - heading "초대형 125x100" [level=4] [ref=e75]
                - img "product.sizes.extraLarge125x100.label" [ref=e76]
          ...
          - complementary [ref=e78]:
            ...
            - generic [ref=e88]:
              ...
              - generic [ref=e92]:
                - button "소형 50x25" [ref=e93] [cursor=pointer]:
                  - generic [ref=e94]: 소형
                  - generic [ref=e95]: 50x25
                - button "중형 75x50" [ref=e96] [cursor=pointer]:
                  - generic [ref=e97]: 중형
                  - generic [ref=e98]: 75x50
                - button "대형 100x75" [ref=e99] [cursor=pointer]:
                  - generic [ref=e100]: 대형
                  - generic [ref=e101]: 100x75
                - button "초대형 125x100" [ref=e102] [cursor=pointer]:
                  - generic [ref=e103]: 초대형
                  - generic [ref=e104]: 125x100
                - button "원하는 크기 입력" [ref=e105] [cursor=pointer]:
                  - paragraph [ref=e106]: 원하는 크기 입력
            - generic [ref=e107]:
              - heading "수량을 선택하세요" [level=3] [ref=e108]
              - generic [ref=e109]:
                - button "5시트 2,790원" [ref=e110] [cursor=pointer]:
                  - generic [ref=e111]: 5시트
                  - generic [ref=e112]: 2,790원
                - button "10시트 5,420원" [ref=e113] [cursor=pointer]:
                  - generic [ref=e114]: 10시트
                  - generic [ref=e115]: 5,420원
                - button "20시트 10,410원" [ref=e116] [cursor=pointer]:
                  - generic [ref=e117]: 20시트
                  - generic [ref=e118]: 10,410원
                - button "50시트 24,710원" [ref=e119] [cursor=pointer]:
                  - generic [ref=e120]: 50시트
                  - generic [ref=e121]: 24,710원
                - button "100시트 47,900원" [ref=e122] [cursor=pointer]:
                  - generic [ref=e123]: 100시트
                  - generic [ref=e124]: 47,900원
                - button "200시트 85,970원" [ref=e125] [cursor=pointer]:
                  - generic [ref=e126]: 200시트
                  - generic [ref=e127]: 85,970원
                - button "500시트 154,700원" [ref=e128] [cursor=pointer]:
                  - generic [ref=e129]: 500시트
                  - generic [ref=e130]: 154,700원
                - button "1,000시트 233,760원" [ref=e131] [cursor=pointer]:
                  - generic [ref=e132]: 1,000시트
                  - generic [ref=e133]: 233,760원
                - button "원하는 수량 입력" [ref=e134] [cursor=pointer]:
                  - paragraph [ref=e135]: 원하는 수량 입력
            - region "Sheet summary" [ref=e136]:
              - img "A5 sheet" [ref=e137]
              - generic [ref=e138]:
                - paragraph [ref=e139]: 1시트 = 스티커 12개
                - paragraph [ref=e140]: "총 스티커 수량 : 60개"
            - generic [ref=e143]:
              - paragraph [ref=e145]:
                - strong [ref=e146]: 2,790원
              - paragraph [ref=e147]: (1매당 46.5원)
            - generic [ref=e148]:
              - generic [ref=e149]:
      ...
      - generic [ref=e613]:
        - generic [ref=e614]:
          - img "text" [ref=e615]
          - generic [ref=e616]:
            - heading "타원형 시트 스티커 FAQ" [level=2] [ref=e617]
            - paragraph [ref=e618]:
        ...
        - generic [ref=e620]:
          - generic [ref=e621]:
            - generic [ref=e622] [cursor=pointer]:
              - heading "타원형 시트 스티커란 무엇인가요?" [level=3] [ref=e623]
              - paragraph [ref=e626]: 타원형 시트 스티커는 여러 개의 타원형 스티커를 한 장의 시트에 배치해 제작하는 스티커입니다. 각 스티커는 키스컷 방식으로 제작되어 시트는 그대로 유지되며, 스티커를 한 장씩 쉽게 떼어 사용할 수 있습니다.
            - button [ref=e627] [cursor=pointer]:
              - img [ref=e628]
          - generic [ref=e630]:
            - generic [ref=e631] [cursor=pointer]:
              - heading "타원형 시트 스티커는 방수 및 내구성이 있나요?" [level=3] [ref=e632]
              - paragraph [ref=e633]: 네. 머스티커의 타원형 시트 스티커는 방수 기능이 있으며, 내구성이 뛰어난 PVC 소재로 제작됩니다. 다만 날카로운 물체나 강한 마찰에는 긁힘이 생길 수 있으니 주의해 주세요.
            - button [ref=e634] [cursor=pointer]:
              - img [ref=e635]
          - generic [ref=e637]:
            - generic [ref=e638] [cursor=pointer]:
              - heading "한 장의 시트에는 타원형 스티커를 몇 개까지 제작할 수 있나요?" [level=3] [ref=e639]
              - paragraph [ref=e640]: 선택한 스티커 사이즈와 시트 크기에 따라 제작 가능한 수량이 달라집니다. 작은 스티커는 한 장의 시트에 더 많이 배치할 수 있으며, 큰 스티커는 제작 가능한 수량이 줄어듭니다.
            - button [ref=e641] [cursor=pointer]:
              - img [ref=e642]
          - generic [ref=e644]:
            - generic [ref=e645] [cursor=pointer]:
              - heading "타원형 시트 스티커는 어떤 소재를 선택할 수 있나요?" [level=3] [ref=e646]
              - paragraph [ref=e647]: 타원형 시트 스티커는 PVC(백색), 투명, 홀로그램 소재로 제작할 수 있습니다. 제품 라벨부터 홍보용 스티커까지 용도에 맞는 소재를 선택해 원하는 분위기를 연출할 수 있습니다.
            - button [ref=e648] [cursor=pointer]:
              - img [ref=e649]
          - generic [ref=e651]:
            - generic [ref=e652] [cursor=pointer]:
              - heading "타원형 스티커는 가로형과 세로형 모두 제작할 수 있나요?" [level=3] [ref=e653]
              - paragraph [ref=e654]: 네. 디자인에 맞게 가로형 또는 세로형으로 제작할 수 있습니다. 가로형은 가로로 넓은 디자인에, 세로형은 세로로 긴 디자인에 적합합니다.
