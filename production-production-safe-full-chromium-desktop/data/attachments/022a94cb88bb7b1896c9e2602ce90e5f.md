...
- Name: pricing/price-interpolation.spec.ts >> pricing interpolation clear-sticker >> MS-PRC-INT-clear-sticker area 543000 (724x750) interpolates between 540000 and 546000
- Location: tests/e2e/pricing/price-interpolation.spec.ts:103:7

# Error details

```
Error: clear-sticker area 543000 (724x750) qty 300 lower bound total should be the UNROUNDED 540000 row product: served pricing_id=49 "clear sticker - 9/9/2026"

expect(received).toBeCloseTo(expected, precision)

Expected: 3622499.8200000003
Received: 3065202

Expected precision:    4
Expected difference: < 0.00005
Received difference:   557297.8200000003
```
