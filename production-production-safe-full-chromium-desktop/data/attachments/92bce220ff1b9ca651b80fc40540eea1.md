...
- Name: pricing/price-interpolation.spec.ts >> pricing interpolation die-cut-roll >> MS-PRC-INT-die-cut-roll area 312 (13x24) interpolates between 225 and 400
- Location: tests/e2e/pricing/price-interpolation.spec.ts:103:7

# Error details

```
Error: die-cut-roll area 312 (13x24) qty 300 lower bound total should be the UNROUNDED 225 row product: served pricing_id=53 "diecut/kisscut roll - 9/10/2026"
