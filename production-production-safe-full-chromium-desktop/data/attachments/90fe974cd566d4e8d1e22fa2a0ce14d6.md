...
- Name: pricing/price-table.spec.ts >> pricing table kiss-cut-sticker >> MS-PRC-kiss-cut-sticker area 50625 (225x225) matches stickers/kiss-cut-sticker.csv
- Location: tests/e2e/pricing/price-table.spec.ts:59:7

# Error details

```
Error: kiss-cut-sticker area 50625 (225x225): served pricing_id=44 "Die Cut / Kiss Cut Sticker (8/24/2026)"
