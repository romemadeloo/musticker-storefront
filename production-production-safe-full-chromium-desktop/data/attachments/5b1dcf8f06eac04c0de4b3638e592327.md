...
- Name: pricing/price-interpolation.spec.ts >> pricing interpolation circle-sticker >> MS-PRC-INT-circle-sticker quantity 15 interpolates between rungs 10 and 20
- Location: tests/e2e/pricing/price-interpolation.spec.ts:160:7

# Error details

```
Error: circle-sticker 385x385 qty=15: pricing API returned 403 Forbidden for https://api.musticker.com/index.php/sys/kr/pricing/quotation/circle-sticker?width=385&height=385&quantity=15&debug=1 on all 5 attempts over ~29s.
