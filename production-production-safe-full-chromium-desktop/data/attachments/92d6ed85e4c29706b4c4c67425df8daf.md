    ...
    - generic [ref=e31]:
      ...
      - generic [ref=e992]:
        - generic [ref=e993]:
          - img "text" [ref=e994]
          - generic [ref=e995]:
            - heading "둥근 사각 시트 스티커 FAQ" [level=2] [ref=e996]
            - paragraph [ref=e997]:
        ...
        - generic [ref=e999]:
          - generic [ref=e1000]:
            - generic [ref=e1001] [cursor=pointer]:
              - heading "둥근사각형 시트 스티커란 무엇인가요?" [level=3] [ref=e1002]
              - paragraph [ref=e1005]: 둥근사각형 시트 스티커는 모서리가 둥글게 처리된 정사각형 또는 직사각형 스티커를 한 장의 시트에 배치해 제작하는 스티커입니다. 각 스티커는 키스컷 방식으로 제작되어 시트는 그대로 유지되며, 스티커를 한 장씩 쉽게 떼어 사용할 수 있습니다.
            - button [ref=e1006] [cursor=pointer]:
              - img [ref=e1007]
          - generic [ref=e1009]:
            - generic [ref=e1010] [cursor=pointer]:
              - heading "둥근사각형 시트 스티커는 어떤 소재를 선택할 수 있나요?" [level=3] [ref=e1011]
              - paragraph [ref=e1012]: 둥근사각형 시트 스티커는 PVC(백색), 투명, 홀로그램 소재로 제작할 수 있습니다. 선명한 색감을 원한다면 PVC(백색), 깔끔하고 자연스러운 느낌을 원한다면 투명, 반짝이는 효과를 원한다면 홀로그램을 추천합니다.
            - button [ref=e1013] [cursor=pointer]:
              - img [ref=e1014]
          - generic [ref=e1016]:
            - generic [ref=e1017] [cursor=pointer]:
              - heading "모서리의 둥근 정도를 선택할 수 있나요?" [level=3] [ref=e1018]
              - paragraph [ref=e1019]: 모서리의 둥근 정도는 상품 규격과 선택한 사이즈에 따라 달라집니다. 원하는 모서리 형태가 있는 경우에는 디자인 파일과 함께 요청 사항을 남겨 주시면 제작 전에 확인해 드립니다.
            - button [ref=e1020] [cursor=pointer]:
              - img [ref=e1021]
          - generic [ref=e1023]:
            - generic [ref=e1024] [cursor=pointer]:
              - heading "둥근사각형 시트 스티커는 쉽게 떼어 사용할 수 있나요?" [level=3] [ref=e1025]
              - paragraph [ref=e1026]: 네. 모든 스티커는 키스컷 방식으로 제작되어 시트에서 한 장씩 쉽게 떼어 사용할 수 있습니다. 둥근 모서리 덕분에 가장자리가 걸리는 현상을 줄여 더욱 편리하게 사용할 수 있습니다.
            - button [ref=e1027] [cursor=pointer]:
              - img [ref=e1028]
          - generic [ref=e1030]:
            - generic [ref=e1031] [cursor=pointer]:
              - heading "둥근사각형 시트 스티커는 방수 및 내구성이 있나요?" [level=3] [ref=e1032]
              - paragraph [ref=e1033]: 네. 머스티커의 둥근사각형 시트 스티커는 방수 기능이 있는 PVC 소재로 제작됩니다. 다만 날카로운 물체나 강한 마찰에는 긁힘이 생길 수 있으니 주의해 주세요.
