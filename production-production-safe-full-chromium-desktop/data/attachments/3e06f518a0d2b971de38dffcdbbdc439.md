...
- Name: pricing/price-interpolation.spec.ts >> pricing interpolation clear-sticker >> MS-PRC-INT-clear-sticker area 146311 (283x517) interpolates between 144400 and 148225
- Location: tests/e2e/pricing/price-interpolation.spec.ts:103:7

# Error details

```
Error: clear-sticker area 146311 (283x517) qty 300 lower bound total should be the UNROUNDED 144400 row product: served pricing_id=49 "clear sticker - 9/9/2026"

expect(received).toBeCloseTo(expected, precision)

Expected: 1063000.0224
Received: 899453.16

Expected precision:    4
Expected difference: < 0.00005
Received difference:   163546.86239999987
```
