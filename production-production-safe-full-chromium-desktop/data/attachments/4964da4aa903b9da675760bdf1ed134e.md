...
- Name: pricing/price-interpolation.spec.ts >> pricing interpolation die-cut-sticker >> MS-PRC-INT-die-cut-sticker area 625 prices the same as 25x25 and 5x125
- Location: tests/e2e/pricing/price-interpolation.spec.ts:191:7

# Error details

```
Error: die-cut-sticker 25x25 qty=300: pricing API returned 403 Forbidden for https://api.musticker.com/index.php/sys/kr/pricing/quotation/die-cut-sticker?width=25&height=25&quantity=300 on all 5 attempts over ~29s.
