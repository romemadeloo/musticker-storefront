...
- Name: pricing/price-table.spec.ts >> pricing table circle-sticker >> MS-PRC-circle-sticker area 140625 (375x375) matches stickers/circle-sticker.csv
- Location: tests/e2e/pricing/price-table.spec.ts:59:7

# Error details

```
Error: circle-sticker area 140625 (375x375): served pricing_id=48 "diecut/kisscut - 9/9/2026"
