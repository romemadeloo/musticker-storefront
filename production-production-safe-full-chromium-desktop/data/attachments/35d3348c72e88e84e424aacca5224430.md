...
- Name: pricing/price-interpolation.spec.ts >> pricing interpolation rounded-sticker >> MS-PRC-INT-rounded-sticker area 146311 (283x517) interpolates between 144400 and 148225
- Location: tests/e2e/pricing/price-interpolation.spec.ts:103:7

# Error details

```
Error: rounded-sticker area 146311 (283x517) qty 300 lower bound total should be the UNROUNDED 144400 row product: served pricing_id=48 "diecut/kisscut - 9/9/2026"
