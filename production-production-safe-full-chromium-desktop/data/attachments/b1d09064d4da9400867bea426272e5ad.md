...
+   "[error] Failed to load resource: the server responded with a status of 403 ()",
+   "[error] TypeError: Failed to fetch dynamically imported module: https://www.musticker.com/_nuxt/CELuPPPw.js",
+   "[error] Failed to load resource: the server responded with a status of 403 ()",
+   "[error] Failed to load resource: the server responded with a status of 403 ()",
+   "[error] TypeError: Failed to fetch dynamically imported module: https://www.musticker.com/_nuxt/CoQq2U0k.js",
+   "[error] Failed to load resource: the server responded with a status of 403 ()",
+ ]
```
...
+   "403 https://www.musticker.com/_nuxt/CELuPPPw.js",
+   "403 https://www.musticker.com/icons/sprite.svg?v=1786003095484",
+   "403 https://www.musticker.com/_nuxt/CoQq2U0k.js",
