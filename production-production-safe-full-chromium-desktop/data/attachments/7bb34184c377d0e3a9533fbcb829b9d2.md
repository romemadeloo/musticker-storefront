...
- Name: purchasing/sheet-sticker-size-rules.spec.ts >> storefront v2 sheet sticker size rules (minimum two stickers per sheet) >> MS-V2-078 circle sheet sticker: 139x97 packs 0 per sheet and is refused
