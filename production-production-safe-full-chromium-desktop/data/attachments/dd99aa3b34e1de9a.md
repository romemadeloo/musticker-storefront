...
Expected pattern: /(?=.*머스티커)(?=.*스티커)/
Received string:  "500 - API Response Contract Violation: Expected ApiResponse structure. | Nuxt"
Timeout: 10000ms

Call log:
  - Expect "toHaveTitle" with timeout 10000ms
    14 × unexpected value "500 - API Response Contract Violation: Expected ApiResponse structure. | Nuxt"
...
+   "500 https://api.musticker.com/index.php/sys/kr/user/me?t=1785878380483",
