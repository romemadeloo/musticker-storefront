    ...
    - generic [ref=e31]:
      - generic [ref=e33]:
        ...
        - generic [ref=e36]:
          - generic [ref=e37]:
            - generic [ref=e38]:
              - heading "원형 롤 스티커" [level=1] [ref=e39]
              - paragraph [ref=e40]: 간편하게 한 장씩 떼어 쓰기 좋은 롤 타입 원형 스티커
            - img "원형 롤 스티커 preview poster" [ref=e42]
            - generic [ref=e44]:
                ...
                - generic [ref=e79] [cursor=pointer]:
                  - generic [ref=e80]:
                    ...
                    - generic [ref=e85]:
                      - generic [ref=e86]: 높이
                      - spinbutton [ref=e87]
                  - paragraph [ref=e88]: 가로·세로 각각 15~300mm 사이로 입력해 주세요.
            - generic [ref=e89]:
      ...
      - generic [ref=e971]:
        - generic [ref=e972]:
          - img "text" [ref=e973]
          - generic [ref=e974]:
            - heading "원형 롤 스티커 FAQ" [level=2] [ref=e975]
            - paragraph [ref=e976]:
        ...
        - generic [ref=e978]:
          - generic [ref=e979]:
            - generic [ref=e980] [cursor=pointer]:
              - heading "원형 롤 스티커가 많이 사용되는 이유는 무엇인가요?" [level=3] [ref=e981]
              - paragraph [ref=e984]: 원형 롤 스티커는 로고, 제품 라벨, 패키지 씰 등 다양한 용도로 활용하기 좋은 형태입니다. 롤 형태라 보관이 편리하고 작업 속도를 높일 수 있어 많이 사용됩니다.
            - button [ref=e985] [cursor=pointer]:
              - img [ref=e986]
          - generic [ref=e988]:
            - generic [ref=e989] [cursor=pointer]:
              - heading "원형 롤 스티커는 어떤 제품에 사용하면 좋나요?" [level=3] [ref=e990]
              - paragraph [ref=e991]: 원형 롤 스티커는 병, 용기, 캔들 뚜껑, 화장품 용기, 식품 포장 등 다양한 제품에 사용하기 좋습니다. 특히 원형 뚜껑이나 작은 패키지의 제품 라벨로 많이 활용됩니다.
            - button [ref=e992] [cursor=pointer]:
              - img [ref=e993]
          - generic [ref=e995]:
            - generic [ref=e996] [cursor=pointer]:
              - heading "원형 롤 스티커도 맞춤 사이즈로 제작할 수 있나요?" [level=3] [ref=e997]
              - paragraph [ref=e998]: 네. 다양한 규격 사이즈를 제공하며, 원하는 사이즈로도 제작할 수 있습니다. 업로드한 디자인은 제작 전에 검토한 후 선택한 사이즈에 맞게 제작됩니다.
            - button [ref=e999] [cursor=pointer]:
              - img [ref=e1000]
          - generic [ref=e1002]:
            - generic [ref=e1003] [cursor=pointer]:
              - heading "원형 롤 스티커는 롤 디스펜서와 함께 사용할 수 있나요?" [level=3] [ref=e1004]
              - paragraph [ref=e1005]: 네. 대부분의 롤 디스펜서와 함께 사용할 수 있어 라벨 작업을 더욱 빠르고 편리하게 진행할 수 있습니다. 반복적으로 스티커를 부착하는 작업에 특히 적합합니다.
            - button [ref=e1006] [cursor=pointer]:
              - img [ref=e1007]
          - generic [ref=e1009]:
            - generic [ref=e1010] [cursor=pointer]:
              - heading "언제 원형 롤 스티커를 선택하면 좋나요?" [level=3] [ref=e1011]
              - paragraph [ref=e1012]: 제품 라벨을 자주 부착하거나 대량으로 작업하는 경우 원형 롤 스티커를 추천합니다. 롤 형태라 보관이 편리하고, 개별 스티커와 달리 롤에서 한 장씩 연속으로 떼어 빠르게 부착할 수 있어 포장 작업 시간을 줄이는 데 도움이 됩니다.
