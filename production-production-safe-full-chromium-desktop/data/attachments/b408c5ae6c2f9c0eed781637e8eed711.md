...
- Location: tests/e2e/purchasing/sheet-sticker-size-rules.spec.ts:48:5
    ...
    - generic [ref=e31]:
      - generic [ref=e33]:
        ...
        - generic [ref=e36]:
          - generic [ref=e37]:
            - generic [ref=e38]:
              - heading "직사각형 시트 스티커" [level=1] [ref=e39]
              - paragraph [ref=e40]: 한 장의 시트에 정돈되어 라벨링 작업에 효율적인 직사각형 시트 스티커
            - img "직사각형 시트 스티커 preview poster" [ref=e42]
            - generic [ref=e44]:
      ...
      - generic [ref=e992]:
        - generic [ref=e993]:
          - img "text" [ref=e994]
          - generic [ref=e995]:
            - heading "직사각형 시트 스티커 FAQ" [level=2] [ref=e996]
            - paragraph [ref=e997]:
        ...
        - generic [ref=e999]:
          - generic [ref=e1000]:
            - generic [ref=e1001] [cursor=pointer]:
              - heading "직사각형 시트 스티커란 무엇인가요?" [level=3] [ref=e1002]
              - paragraph [ref=e1005]: 직사각형 시트 스티커는 여러 개의 직사각형 스티커를 한 장의 시트에 배치해 제작하는 스티커입니다. 각 스티커는 키스컷 방식으로 제작되어 시트는 그대로 유지되며, 스티커를 한 장씩 쉽게 떼어 사용할 수 있습니다
            - button [ref=e1006] [cursor=pointer]:
              - img [ref=e1007]
          - generic [ref=e1009]:
            - generic [ref=e1010] [cursor=pointer]:
              - heading "한 장의 시트에 여러 가지 직사각형 디자인을 넣을 수 있나요?" [level=3] [ref=e1011]
              - paragraph [ref=e1012]: 아니요. 직사각형 시트 스티커는 하나의 디자인이 시트 전체에 반복 배치되어 제작됩니다. 모든 스티커가 동일한 크기와 간격으로 배치되어 깔끔하게 제작됩니다.
            - button [ref=e1013] [cursor=pointer]:
              - img [ref=e1014]
          - generic [ref=e1016]:
            - generic [ref=e1017] [cursor=pointer]:
              - heading "직사각형 시트 스티커는 어떤 소재를 선택할 수 있나요?" [level=3] [ref=e1018]
              - paragraph [ref=e1019]: 직사각형 시트 스티커는 PVC(백색), 투명, 홀로그램 소재로 제작할 수 있습니다. 선명한 색감을 원한다면 PVC(백색), 깔끔하고 자연스러운 느낌을 원한다면 투명, 반짝이는 효과를 원한다면 홀로그램을 추천합니다.
            - button [ref=e1020] [cursor=pointer]:
              - img [ref=e1021]
          - generic [ref=e1023]:
            - generic [ref=e1024] [cursor=pointer]:
              - heading "직사각형 시트 스티커는 방수 및 내구성이 있나요?" [level=3] [ref=e1025]
              - paragraph [ref=e1026]: 네. 머스티커의 직사각형 시트 스티커는 방수 기능이 있는 PVC 소재로 제작됩니다. 다만 날카로운 물체나 강한 마찰에는 긁힘이 생길 수 있으니 주의해 주세요.
            - button [ref=e1027] [cursor=pointer]:
              - img [ref=e1028]
          - generic [ref=e1030]:
            - generic [ref=e1031] [cursor=pointer]:
              - heading "디자인을 직사각형 전체에 인쇄할 수 있나요?" [level=3] [ref=e1032]
              - paragraph [ref=e1033]: 네. 재단선 밖까지 디자인을 여유 있게 넣어 작업하면 직사각형 전체를 가득 채워 인쇄할 수 있습니다. 이렇게 재단 여백을 포함해 디자인하면 흰 테두리 없이 깔끔하게 제작됩니다
