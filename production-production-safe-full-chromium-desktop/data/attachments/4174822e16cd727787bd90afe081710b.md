...
- Name: pricing/price-table.spec.ts >> pricing table circle-roll >> MS-PRC-circle-roll area 30625 (175x175) matches roll-stickers/circle-roll.csv
- Location: tests/e2e/pricing/price-table.spec.ts:59:7

# Error details

```
Error: circle-roll area 30625 (175x175): served pricing_id=53 "diecut/kisscut roll - 9/10/2026"
