    ...
    - generic [ref=e31]:
      ...
      - generic [ref=e992]:
        - generic [ref=e993]:
          - img "text" [ref=e994]
          - generic [ref=e995]:
            - heading "타원형 시트 스티커 FAQ" [level=2] [ref=e996]
            - paragraph [ref=e997]:
        ...
        - generic [ref=e999]:
          - generic [ref=e1000]:
            - generic [ref=e1001] [cursor=pointer]:
              - heading "타원형 시트 스티커란 무엇인가요?" [level=3] [ref=e1002]
              - paragraph [ref=e1005]: 타원형 시트 스티커는 여러 개의 타원형 스티커를 한 장의 시트에 배치해 제작하는 스티커입니다. 각 스티커는 키스컷 방식으로 제작되어 시트는 그대로 유지되며, 스티커를 한 장씩 쉽게 떼어 사용할 수 있습니다.
            - button [ref=e1006] [cursor=pointer]:
              - img [ref=e1007]
          - generic [ref=e1009]:
            - generic [ref=e1010] [cursor=pointer]:
              - heading "타원형 시트 스티커는 방수 및 내구성이 있나요?" [level=3] [ref=e1011]
              - paragraph [ref=e1012]: 네. 머스티커의 타원형 시트 스티커는 방수 기능이 있으며, 내구성이 뛰어난 PVC 소재로 제작됩니다. 다만 날카로운 물체나 강한 마찰에는 긁힘이 생길 수 있으니 주의해 주세요.
            - button [ref=e1013] [cursor=pointer]:
              - img [ref=e1014]
          - generic [ref=e1016]:
            - generic [ref=e1017] [cursor=pointer]:
              - heading "한 장의 시트에는 타원형 스티커를 몇 개까지 제작할 수 있나요?" [level=3] [ref=e1018]
              - paragraph [ref=e1019]: 선택한 스티커 사이즈와 시트 크기에 따라 제작 가능한 수량이 달라집니다. 작은 스티커는 한 장의 시트에 더 많이 배치할 수 있으며, 큰 스티커는 제작 가능한 수량이 줄어듭니다.
            - button [ref=e1020] [cursor=pointer]:
              - img [ref=e1021]
          - generic [ref=e1023]:
            - generic [ref=e1024] [cursor=pointer]:
              - heading "타원형 시트 스티커는 어떤 소재를 선택할 수 있나요?" [level=3] [ref=e1025]
              - paragraph [ref=e1026]: 타원형 시트 스티커는 PVC(백색), 투명, 홀로그램 소재로 제작할 수 있습니다. 제품 라벨부터 홍보용 스티커까지 용도에 맞는 소재를 선택해 원하는 분위기를 연출할 수 있습니다.
            - button [ref=e1027] [cursor=pointer]:
              - img [ref=e1028]
          - generic [ref=e1030]:
            - generic [ref=e1031] [cursor=pointer]:
              - heading "타원형 스티커는 가로형과 세로형 모두 제작할 수 있나요?" [level=3] [ref=e1032]
              - paragraph [ref=e1033]: 네. 디자인에 맞게 가로형 또는 세로형으로 제작할 수 있습니다. 가로형은 가로로 넓은 디자인에, 세로형은 세로로 긴 디자인에 적합합니다.
