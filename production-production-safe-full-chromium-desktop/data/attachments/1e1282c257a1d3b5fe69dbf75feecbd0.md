...
```
Error: die-cut-sticker 25x25 qty=10: pricing API returned 403 Forbidden for https://api.musticker.com/index.php/sys/kr/pricing/quotation/die-cut-sticker?width=25&height=25&quantity=10 on all 5 attempts over ~29s.
