...
- Name: pricing/price-interpolation.spec.ts >> pricing interpolation rectangle-roll >> MS-PRC-INT-rectangle-roll quantity 7500 interpolates between rungs 5000 and 10000
- Location: tests/e2e/pricing/price-interpolation.spec.ts:160:7

# Error details

```
Error: rectangle-roll 130x130 qty=7500: HTTP 502 from https://api.musticker.com/index.php/sys/kr/pricing/quotation/rectangle-roll?width=130&height=130&quantity=7500&debug=1
```
