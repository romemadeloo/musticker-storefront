...
```
Error: Size guide image 0 alt text looks like an unrelated sheet/paper size label: "A6 105x148"

expect(received).not.toMatch(expected)

Expected pattern: not /^A\d+\s|^\d+\s*x\s*\d+$/i
Received string:      "A6 105x148"
```
    ...
    - generic [ref=e31]:
      - generic [ref=e33]:
        ...
        - generic [ref=e36]:
          - generic [ref=e37]:
            - generic [ref=e38]:
              - heading "정사각형 시트 스티커" [level=1] [ref=e39]
              - paragraph [ref=e40]: 한 장의 시트에 정돈되어 사용과 보관이 편리한 정사각형 시트 스티커
            - img "정사각형 시트 스티커 preview poster" [ref=e42]
            - generic [ref=e44]:
          ...
          - complementary [ref=e61]:
            ...
            - generic [ref=e71]:
              ...
              - generic [ref=e75]:
                ...
                - button "중형 75x75" [ref=e79] [cursor=pointer]:
                  - generic [ref=e80]: 중형
                  - generic [ref=e81]: 75x75
                - button "대형 100x100" [ref=e82] [cursor=pointer]:
                  - generic [ref=e83]: 대형
                  - generic [ref=e84]: 100x100
                - button "초대형 125x125" [ref=e85] [cursor=pointer]:
                  - generic [ref=e86]: 초대형
                  - generic [ref=e87]: 125x125
                - button "원하는 크기 입력" [ref=e88] [cursor=pointer]:
                  - paragraph [ref=e89]: 원하는 크기 입력
            - generic [ref=e90]:
              - heading "수량을 선택하세요" [level=3] [ref=e91]
              - generic [ref=e92]:
                - button "5시트 3,450원" [ref=e93] [cursor=pointer]:
                  - generic [ref=e94]: 5시트
                  - generic [ref=e95]: 3,450원
                - button "10시트 6,600원" [ref=e96] [cursor=pointer]:
                  - generic [ref=e97]: 10시트
                  - generic [ref=e98]: 6,600원
                - button "20시트 12,800원" [ref=e99] [cursor=pointer]:
                  - generic [ref=e100]: 20시트
                  - generic [ref=e101]: 12,800원
                - button "50시트 31,000원" [ref=e102] [cursor=pointer]:
                  - generic [ref=e103]: 50시트
                  - generic [ref=e104]: 31,000원
                - button "100시트 60,600원" [ref=e105] [cursor=pointer]:
                  - generic [ref=e106]: 100시트
                  - generic [ref=e107]: 60,600원
                - button "200시트 105,300원" [ref=e108] [cursor=pointer]:
                  - generic [ref=e109]: 200시트
                  - generic [ref=e110]: 105,300원
                - button "500시트 185,000원" [ref=e111] [cursor=pointer]:
                  - generic [ref=e112]: 500시트
                  - generic [ref=e113]: 185,000원
                - button "1,000시트 250,000원" [ref=e114] [cursor=pointer]:
                  - generic [ref=e115]: 1,000시트
                  - generic [ref=e116]: 250,000원
                - button "원하는 수량 입력" [ref=e117] [cursor=pointer]:
                  - paragraph [ref=e118]: 원하는 수량 입력
            - region "Sheet summary" [ref=e119]:
              - img "A5 sheet" [ref=e120]
              - generic [ref=e121]:
                - paragraph [ref=e122]: 1시트 = 스티커 20개
                - paragraph [ref=e123]: "총 스티커 수량 : 100개"
            - generic [ref=e126]:
              - paragraph [ref=e128]:
                - strong [ref=e129]: 3,450원
              - paragraph [ref=e130]: (1매당 34.5원)
            - generic [ref=e131]:
              - generic [ref=e132]:
            ...
            - list [ref=e142]:
              ...
              - listitem [ref=e145]: "도착 예정일: 08.21 (금) · CJ 대한통운"
      ...
      - generic [ref=e596]:
        - generic [ref=e597]:
          - img "text" [ref=e598]
          - generic [ref=e599]:
            - heading "정사각형 시트 스티커 FAQ" [level=2] [ref=e600]
            - paragraph [ref=e601]:
        ...
        - generic [ref=e603]:
          - generic [ref=e604]:
            - generic [ref=e605] [cursor=pointer]:
              - heading "정사각형 시트 스티커란 무엇인가요?" [level=3] [ref=e606]
              - paragraph [ref=e609]: 정사각형 시트 스티커는 여러 개의 정사각형 스티커를 한 장의 시트에 배치해 제작하는 스티커입니다. 각 스티커는 키스컷 방식으로 제작되어 시트는 그대로 유지되며, 스티커를 한 장씩 쉽게 떼어 사용할 수 있습니다.
            - button [ref=e610] [cursor=pointer]:
              - img [ref=e611]
          - generic [ref=e613]:
            - generic [ref=e614] [cursor=pointer]:
              - heading "정사각형 시트 스티커는 어떤 소재로 제작되나요?" [level=3] [ref=e615]
              - paragraph [ref=e616]: 머스티커의 정사각형 시트 스티커는 방수 기능이 있는 PVC 소재로 제작되어 인쇄가 선명하고 형태가 안정적입니다. 다만 날카로운 물체나 강한 마찰에는 긁힘이 생길 수 있으니 주의해 주세요.
            - button [ref=e617] [cursor=pointer]:
              - img [ref=e618]
          - generic [ref=e620]:
            - generic [ref=e621] [cursor=pointer]:
              - heading "정사각형 시트 스티커도 둥근 모서리로 제작할 수 있나요?" [level=3] [ref=e622]
              - paragraph [ref=e623]: 아니요. 정사각형 시트 스티커는 직각 모서리로 제작됩니다. 둥근 모서리를 원하신다면 둥근사각형 시트 스티커를 선택해 주세요.
            - button [ref=e624] [cursor=pointer]:
              - img [ref=e625]
          - generic [ref=e627]:
            - generic [ref=e628] [cursor=pointer]:
              - heading "한 장의 시트에 있는 정사각형 스티커는 모두 같은 디자인인가요?" [level=3] [ref=e629]
              - paragraph [ref=e630]: 네. 정사각형 시트 스티커는 하나의 디자인이 시트 전체에 반복 배치되어 제작됩니다. 모든 스티커가 동일한 크기와 모양, 색상으로 제작됩니다.
            - button [ref=e631] [cursor=pointer]:
              - img [ref=e632]
          - generic [ref=e634]:
            - generic [ref=e635] [cursor=pointer]:
              - heading "정사각형 시트 스티커는 어떤 소재를 선택할 수 있나요?" [level=3] [ref=e636]
              - paragraph [ref=e637]: 정사각형 시트 스티커는 PVC(백색), 투명, 홀로그램 소재로 제작할 수 있습니다. 선명한 색감을 원한다면 PVC(백색), 깔끔하고 자연스러운 느낌을 원한다면 투명, 반짝이는 효과를 원한다면 홀로그램을 추천합니다.
