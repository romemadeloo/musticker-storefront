    ...
    - generic [ref=e48]:
      ...
      - generic [ref=e577]:
        - generic [ref=e578]:
          - img "text" [ref=e579]
          - generic [ref=e580]:
            - heading "정사각형 시트 스티커 FAQ" [level=2] [ref=e581]
            - paragraph [ref=e582]:
        ...
        - generic [ref=e584]:
          - generic [ref=e585]:
            - generic [ref=e586] [cursor=pointer]:
              - heading "정사각형 시트 스티커란 무엇인가요?" [level=3] [ref=e587]
              - paragraph [ref=e590]: 정사각형 시트 스티커는 여러 개의 정사각형 스티커를 한 장의 시트에 배치해 제작하는 스티커입니다. 각 스티커는 키스컷 방식으로 제작되어 시트는 그대로 유지되며, 스티커를 한 장씩 쉽게 떼어 사용할 수 있습니다.
            - button [ref=e591] [cursor=pointer]:
              - img [ref=e592]
          - generic [ref=e594]:
            - generic [ref=e595] [cursor=pointer]:
              - heading "정사각형 시트 스티커는 어떤 소재로 제작되나요?" [level=3] [ref=e596]
              - paragraph [ref=e597]: 머스티커의 정사각형 시트 스티커는 방수 기능이 있는 PVC 소재로 제작되어 인쇄가 선명하고 형태가 안정적입니다. 다만 날카로운 물체나 강한 마찰에는 긁힘이 생길 수 있으니 주의해 주세요.
            - button [ref=e598] [cursor=pointer]:
              - img [ref=e599]
          - generic [ref=e601]:
            - generic [ref=e602] [cursor=pointer]:
              - heading "정사각형 시트 스티커도 둥근 모서리로 제작할 수 있나요?" [level=3] [ref=e603]
              - paragraph [ref=e604]: 아니요. 정사각형 시트 스티커는 직각 모서리로 제작됩니다. 둥근 모서리를 원하신다면 둥근사각형 시트 스티커를 선택해 주세요.
            - button [ref=e605] [cursor=pointer]:
              - img [ref=e606]
          - generic [ref=e608]:
            - generic [ref=e609] [cursor=pointer]:
              - heading "한 장의 시트에 있는 정사각형 스티커는 모두 같은 디자인인가요?" [level=3] [ref=e610]
              - paragraph [ref=e611]: 네. 정사각형 시트 스티커는 하나의 디자인이 시트 전체에 반복 배치되어 제작됩니다. 모든 스티커가 동일한 크기와 모양, 색상으로 제작됩니다.
            - button [ref=e612] [cursor=pointer]:
              - img [ref=e613]
          - generic [ref=e615]:
            - generic [ref=e616] [cursor=pointer]:
              - heading "정사각형 시트 스티커는 어떤 소재를 선택할 수 있나요?" [level=3] [ref=e617]
              - paragraph [ref=e618]: 정사각형 시트 스티커는 PVC(백색), 투명, 홀로그램 소재로 제작할 수 있습니다. 선명한 색감을 원한다면 PVC(백색), 깔끔하고 자연스러운 느낌을 원한다면 투명, 반짝이는 효과를 원한다면 홀로그램을 추천합니다.
