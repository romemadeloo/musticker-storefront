...
- Name: discovery/search.spec.ts >> search >> shows an explicit empty state without stale results for an unknown product
- Location: tests/e2e/discovery/search.spec.ts:37:3
