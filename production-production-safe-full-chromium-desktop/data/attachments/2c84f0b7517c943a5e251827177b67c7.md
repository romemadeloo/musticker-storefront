    ...
    - generic [ref=e48]:
      - generic [ref=e50]:
        ...
        - generic [ref=e53]:
          - generic [ref=e54]:
            - generic [ref=e55]:
              - heading "원형 시트 스티커" [level=1] [ref=e56]
              - paragraph [ref=e57]: 사용과 보관이 편리하도록 시트 한 장에 담긴 원형 시트 스티커
            - img "원형 시트 스티커 preview poster" [ref=e59]
            - generic [ref=e61]:
              - button "소형 40x40 product.sizes.small40x40.label 작고 귀여운 크기로 휴대폰 케이스나 헬멧에 딱!" [ref=e62] [cursor=pointer]:
                - heading "소형 40x40" [level=4] [ref=e63]
                - img "product.sizes.small40x40.label" [ref=e64]
                - paragraph [ref=e65]: 작고 귀여운 크기로 휴대폰 케이스나 헬멧에 딱!
              - button "중형 60x60 product.sizes.medium60x60.label 텀블러·노트북에 잘 어울려요. 가장 인기 있는 사이즈예요." [ref=e66] [cursor=pointer]:
                - heading "중형 60x60" [level=4] [ref=e67]
                - img "product.sizes.medium60x60.label" [ref=e68]
                - paragraph [ref=e69]: 텀블러·노트북에 잘 어울려요. 가장 인기 있는 사이즈예요.
              - button "대형 80x80 product.sizes.large80x80.label 보드나 캐리어에 붙이면 눈에 잘 띄는 크기예요." [ref=e70] [cursor=pointer]:
                - heading "대형 80x80" [level=4] [ref=e71]
                - img "product.sizes.large80x80.label" [ref=e72]
                - paragraph [ref=e73]: 보드나 캐리어에 붙이면 눈에 잘 띄는 크기예요.
              - button "초대형 100x100 product.sizes.extraLarge100x100.label 차·아이스박스·공구함에도 딱 맞는 넉넉한 크기예요." [ref=e74] [cursor=pointer]:
                - heading "초대형 100x100" [level=4] [ref=e75]
                - img "product.sizes.extraLarge100x100.label" [ref=e76]
          ...
          - complementary [ref=e78]:
            ...
            - generic [ref=e88]:
              ...
              - generic [ref=e92]:
                - button "소형 40x40" [ref=e93] [cursor=pointer]:
                  - generic [ref=e94]: 소형
                  - generic [ref=e95]: 40x40
                - button "중형 60x60" [ref=e96] [cursor=pointer]:
                  - generic [ref=e97]: 중형
                  - generic [ref=e98]: 60x60
                - button "대형 80x80" [ref=e99] [cursor=pointer]:
                  - generic [ref=e100]: 대형
                  - generic [ref=e101]: 80x80
                - button "초대형 100x100" [ref=e102] [cursor=pointer]:
                  - generic [ref=e103]: 초대형
                  - generic [ref=e104]: 100x100
                - button "원하는 크기 입력" [ref=e105] [cursor=pointer]:
                  - paragraph [ref=e106]: 원하는 크기 입력
            - generic [ref=e107]:
              - heading "수량을 선택하세요" [level=3] [ref=e108]
              - generic [ref=e109]:
                - button "5시트 3,420원" [ref=e110] [cursor=pointer]:
                  - generic [ref=e111]: 5시트
                  - generic [ref=e112]: 3,420원
                - button "10시트 6,630원" [ref=e113] [cursor=pointer]:
                  - generic [ref=e114]: 10시트
                  - generic [ref=e115]: 6,630원
                - button "20시트 12,500원" [ref=e116] [cursor=pointer]:
                  - generic [ref=e117]: 20시트
                  - generic [ref=e118]: 12,500원
                - button "50시트 29,540원" [ref=e119] [cursor=pointer]:
                  - generic [ref=e120]: 50시트
                  - generic [ref=e121]: 29,540원
                - button "100시트 57,200원" [ref=e122] [cursor=pointer]:
                  - generic [ref=e123]: 100시트
                  - generic [ref=e124]: 57,200원
                - button "200시트 105,120원" [ref=e125] [cursor=pointer]:
                  - generic [ref=e126]: 200시트
                  - generic [ref=e127]: 105,120원
                - button "500시트 203,800원" [ref=e128] [cursor=pointer]:
                  - generic [ref=e129]: 500시트
                  - generic [ref=e130]: 203,800원
                - button "1,000시트 331,200원" [ref=e131] [cursor=pointer]:
                  - generic [ref=e132]: 1,000시트
                  - generic [ref=e133]: 331,200원
            ...
            - generic [ref=e143]:
              - paragraph [ref=e145]:
                - strong [ref=e146]: 3,420원
              - paragraph [ref=e147]: (1매당 57원)
            - generic [ref=e148]:
              - generic [ref=e149]:
      ...
      - generic [ref=e613]:
        - generic [ref=e614]:
          - img "text" [ref=e615]
          - generic [ref=e616]:
            - heading "원형 시트 스티커 FAQ" [level=2] [ref=e617]
            - paragraph [ref=e618]:
        ...
        - generic [ref=e620]:
          - generic [ref=e621]:
            - generic [ref=e622] [cursor=pointer]:
              - heading "원형 시트 스티커란 무엇인가요?" [level=3] [ref=e623]
              - paragraph [ref=e626]: 원형 시트 스티커는 여러 개의 원형 스티커를 한 장의 시트에 배치해 제작하는 스티커입니다. 각 스티커는 키스컷 방식으로 제작되어 시트는 그대로 유지되며, 스티커를 한 장씩 쉽게 떼어 사용할 수 있습니다.
            - button [ref=e627] [cursor=pointer]:
              - img [ref=e628]
          - generic [ref=e630]:
            - generic [ref=e631] [cursor=pointer]:
              - heading "원형 시트 스티커는 방수 및 내구성이 있나요?" [level=3] [ref=e632]
              - paragraph [ref=e633]: 네. 머스티커의 원형 시트 스티커는 방수 기능이 있는 PVC 소재로 제작됩니다. 둥근 형태로 가장자리가 깔끔하게 마감되어 다양한 용도로 편리하게 사용할 수 있습니다. 다만 날카로운 물체나 강한 마찰에는 긁힘이 생길 수 있으니 주의해 주세요.
            - button [ref=e634] [cursor=pointer]:
              - img [ref=e635]
          - generic [ref=e637]:
            - generic [ref=e638] [cursor=pointer]:
              - heading "한 장의 시트에 여러 가지 원형 디자인을 넣을 수 있나요?" [level=3] [ref=e639]
              - paragraph [ref=e640]: 아니요. 원형 시트 스티커는 하나의 디자인이 시트 전체에 반복 배치되어 제작됩니다. 모든 스티커가 동일한 크기와 간격으로 배치되어 깔끔하게 제작됩니다.
            - button [ref=e641] [cursor=pointer]:
              - img [ref=e642]
          - generic [ref=e644]:
            - generic [ref=e645] [cursor=pointer]:
              - heading "원형 스티커는 정확한 원형으로 제작되나요?" [level=3] [ref=e646]
              - paragraph [ref=e647]: 네. 모든 원형 스티커는 깔끔한 원형으로 제작됩니다. 디자인이 중앙에 맞게 배치되어 좌우 균형이 잘 잡힌 형태로 완성됩니다.
            - button [ref=e648] [cursor=pointer]:
              - img [ref=e649]
          - generic [ref=e651]:
            - generic [ref=e652] [cursor=pointer]:
              - heading "원형 시트 스티커는 어떤 소재를 선택할 수 있나요?" [level=3] [ref=e653]
              - paragraph [ref=e654]: 원형 시트 스티커는 PVC(백색), 투명, 홀로그램 소재로 제작할 수 있습니다. 선명한 색감을 원한다면 PVC(백색), 깔끔하고 자연스러운 느낌을 원한다면 투명, 반짝이는 효과를 원한다면 홀로그램을 추천합니다.
