...
- Name: pricing/price-interpolation.spec.ts >> pricing interpolation sticker-sheet >> MS-PRC-INT-sticker-sheet quantity 15 interpolates between rungs 10 and 20
- Location: tests/e2e/pricing/price-interpolation.spec.ts:160:7

# Error details

```
Error: sticker-sheet 430x430 qty=15: pricing API returned 403 Forbidden for https://api.musticker.com/index.php/sys/kr/pricing/quotation/sticker-sheet?width=430&height=430&quantity=15&debug=1 on all 5 attempts over ~29s.
