...
- Name: edgecases/storefront-edgecases.spec.ts >> production-safe storefront edge cases >> guest-only account routes do not expose member data
- Location: tests/e2e/edgecases/storefront-edgecases.spec.ts:161:3
...
+   "[error] [nuxt] error caught during app initialization {error: true, url: /kr/account/orders, statusCode: 500, statusMessage: API Response Contract Violation: Expected ApiResponse structure., message: API Response Contract Violation: Expected ApiResponse structure.}",
+   "[warning] Static review preload failed. Ec: API Response Contract Violation: Expected ApiResponse structure.
+     at x_ (https://www.musticker.com/_nuxt/dAyZ8cRt.js:4:79257)
+     at f0 (https://www.musticker.com/_nuxt/dAyZ8cRt.js:4:82056)
+     at https://www.musticker.com/_nuxt/dAyZ8cRt.js:4:106725
...
+     at J_ (https://www.musticker.com/_nuxt/dAyZ8cRt.js:4:89325)
+     at X_ (https://www.musticker.com/_nuxt/dAyZ8cRt.js:4:86532)",
+   "[error] [nuxt] error caught during app initialization {error: true, url: /kr/account/profile, statusCode: 500, statusMessage: API Response Contract Violation: Expected ApiResponse structure., message: API Response Contract Violation: Expected ApiResponse structure.}",
+   "[warning] Static review preload failed. Ec: API Response Contract Violation: Expected ApiResponse structure.
+     at x_ (https://www.musticker.com/_nuxt/dAyZ8cRt.js:4:79257)
+     at f0 (https://www.musticker.com/_nuxt/dAyZ8cRt.js:4:82056)
+     at https://www.musticker.com/_nuxt/dAyZ8cRt.js:4:106725
...
+     at J_ (https://www.musticker.com/_nuxt/dAyZ8cRt.js:4:89325)
+     at X_ (https://www.musticker.com/_nuxt/dAyZ8cRt.js:4:86532)",
+   "[error] [nuxt] error caught during app initialization {error: true, url: /kr/account, statusCode: 500, statusMessage: API Response Contract Violation: Expected ApiResponse structure., message: API Response Contract Violation: Expected ApiResponse structure.}",
+ ]
```
...
- Array []
+ Array [
+   "500 https://www.musticker.com/kr/account/orders",
+   "500 https://api.musticker.com/index.php/sys/kr/navigation/categories",
+   "500 https://api.musticker.com/index.php/sys/kr/user/me?t=1785878341697",
+   "500 https://api.musticker.com/index.php/sys/kr/user/me?t=1785878342187",
+   "500 https://api.musticker.com/index.php/sys/kr/seo?page=%2Fkr",
+   "500 https://www.musticker.com/kr/account/profile",
+   "500 https://api.musticker.com/index.php/sys/kr/navigation/categories",
+   "500 https://api.musticker.com/index.php/sys/kr/user/me?t=1785878344566",
+   "500 https://api.musticker.com/index.php/sys/kr/user/me?t=1785878344949",
+   "500 https://api.musticker.com/index.php/sys/kr/seo?page=%2Fkr",
+   "500 https://www.musticker.com/kr/account",
+   "500 https://api.musticker.com/index.php/sys/kr/navigation/categories",
+   "500 https://api.musticker.com/index.php/sys/kr/user/me?t=1785878347014",
+   "500 https://api.musticker.com/index.php/sys/kr/user/me?t=1785878347392",
+   "500 https://api.musticker.com/index.php/sys/kr/seo?page=%2Fkr",
+ ]
```
