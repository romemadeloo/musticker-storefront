...
- Name: edgecases/storefront-edgecases.spec.ts >> production-safe storefront edge cases >> direct checkout access with an empty cart cannot submit an order
- Location: tests/e2e/edgecases/storefront-edgecases.spec.ts:104:3
